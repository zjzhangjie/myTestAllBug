...
!(function(t) {
  ...
  function(t, e, i) {
    function n(t) {
      ...
      if (t && "object" == typeof t) {
        for (
          r = {}, i = [Array, Number, String, Boolean], e = 0;
          e < i.length;
          e++
        )
    ...
    function l(t, e, i, n) {
      t.addEventListener
        ? t.addEventListener(e, i, void 0 !== n && n)
        : t.attachEvent && t.attachEvent("on" + e, i);
    }
    function d(t, e, i, n) {
      t.removeEventListener
        ? t.removeEventListener(e, i, void 0 !== n && n)
  ...
  function(t, e) {
    function i(t) {
      ...
      if (t.getBoundingClientRect) {
        ...
        (e = a.top + l - c),
          (i = a.left + d - h),
          (n = document.body.offsetWidth - a.right),
          (r = document.body.offsetHeight - a.bottom);
      } else {
        for (; t; )
          (e += parseInt(t.offsetTop, 10)),
            (i += parseInt(t.offsetLeft, 10)),
            (t = t.offsetParent);
        (n = document.body.offsetWidth - t.offsetWidth - i),
    ...
    function n(t) {
      ...
      if (window.getComputedStyle) {
        ...
        t.currentStyle &&
          ((e = t.currentStyle.display), (i = t.currentStyle.visibility));
      return "none" != e && "hidden" != i;
    }
    function r(t) {
      return (
        !isNaN(t.getAttribute("tabindex")) &&
        1 * t.getAttribute("tabindex") >= 0
      );
    }
    function a(t) {
      return (
        !{ a: !0, area: !0 }[t.nodeName.loLowerCase()] ||
        !!t.getAttribute("href")
      );
    }
    function s(t) {
    ...
    function o(t) {
      for (
        var e = t.querySelectorAll(
          ...
          i = Array.prototype.slice.call(e, 0),
          o = 0;
        o < i.length;
        o++
      ) {
    ...
    function p(t) {
      ...
      return (
        t.tagName
          ? (e = t)
          : ((t = t || window.event), (e = t.target || t.srcElement)),
        e
      );
    }
    function v(t, e) {
    ...
    function y(t, e) {
      if (t.pageX || t.pageY) var n = { x: t.pageX, y: t.pageY };
      var r = document.documentElement,
        ...
        a = i(e);
      return (
        (n.x = n.x - a.x + e.scrollLeft), (n.y = n.y - a.y + e.scrollTop), n
      );
    }
    function b(t, e) {
      if (!t || !e) return !1;
    ...
    function i(t) {
      ...
      (t.attachEvent = function(t, i, n) {
        ...
        (t.callEvent = function(t, i, n) {
          ...
          return (
            e.ev_listen_all && e.ev_listen_all.apply(n || this, [t].concat(i)),
            !e[r] || e[r].apply(n || this, i)
          );
        }),
  ...
  function(t, e) {
    function i(t) {
      ...
      for (var i = 0; i < e.length; i++) if (!t[e[i]]) return !1;
      return !0;
    }
    t.exports = { isDate: i };
  },
      ...
      s = (function() {
        ...
        function t(t, e, i, s) {
          t && ((this.$container = a.toNode(t)), (this.$parent = t)),
            (this.$config = n.mixin(e, { headerHeight: 33 })),
            (this.$gantt = s),
            (this.$domEvents = s._createDomEventScope()),
            (this.$id = e.id || "c" + n.uid()),
            (this.$name = "cell"),
            (this.$factory = i),
            r(this);
        }
        return (
          ...
          (t.prototype.scrollTo = function(t, e) {
            1 * t == t && (this.$view.scrollLeft = t),
              1 * e == e && (this.$view.scrollTop = e);
          }),
          ...
          (t.prototype.resize = function(t) {
            ...
            e === document.body &&
              ...
              n < r.minHeight && (n = r.minHeight),
              n > r.maxHeight && (n = r.maxHeight),
              this.setSize(i, n);
          ...
          (t.prototype.$toHTML = function(t, e) {
            ...
            var i = this.$config,
              n = "";
            if (i.raw) t = "string" == typeof i.raw ? i.raw : "";
            else if (
              (t ||
                (t =
          ...
          (t.prototype.setSize = function(t, e) {
            ...
            var i = this._getBorderSizes(),
              n = e - i.vertical,
              r = t - i.horizontal;
            (this.$lastSize = { x: t, y: e, contentX: r, contentY: n }),
          ...
          (t.prototype._sizeContent = function() {
            ...
            t &&
              "gantt_layout_content" == t.className &&
              (t.style.height = this.$lastSize.contentY + "px");
          }),
  ...
  function(t, e) {
    ...
    t.exports = { getSecondsInUnit: i, forEach: n, arrayMap: r };
  },
  function(t, e, i) {
    var n = i(1),
      r = i(0),
    ...
    (o.prototype = {
      init: function(t) {
        ...
        if (
          (!a && this.$config.bind && (a = this.$config.bind + "_id"),
          (this.$config.item_attribute = a || null),
          !this.$config.layers)
        ) {
      ...
      setSize: function(t, e) {
        ...
        for (
          var i = this.getGridColumns(), n = 0, r = 0, a = i.length;
          r < a;
          r++
        )
          n += 1 * i[r].width;
        var s;
        (!isNaN(n) && this.$config.scrollable) ||
          ((s = this._setColumnsWidth(t + 1)), (n = s)),
          this.$config.scrollable
            ? ((this.$grid_scale.style.width = n + "px"),
              (this.$grid_data.style.width = n + "px"))
      ...
      scrollTo: function(t, e) {
        this.isVisible() &&
          (1 * t == t && (this.$state.scrollLeft = this.$grid.scrollLeft = t),
          1 * e == e &&
            (this.$state.scrollTop = this.$grid_data.scrollTop = e));
      },
      ...
      _addLayers: function(t) {
        if (this.$config.bind) {
          ...
          this.$config.bind &&
            (this.$config.rowStore = this.$gantt.getDatastore(
              this.$config.bind
            )),
            this._initSmartRenderingPlaceholder();
        }
      ...
      _initSmartRenderingPlaceholder: function() {
        ...
        e &&
          ...
          (this._staticBgHandler = e.attachEvent("onStoreUpdated", function(
            i,
            n,
            r
          ) {
            if (null === i && t.isVisible()) {
              ...
              if (a.smart_rendering) {
                ...
                if (s) {
                  t.$rowsPlaceholder &&
                    t.$rowsPlaceholder.parentNode &&
                    t.$rowsPlaceholder.parentNode.removeChild(
                      t.$rowsPlaceholder
                    );
      ...
      _initEvents: function() {
        this._mouseDelegates.delegate(
          "click",
          "gantt_close",
          gantt.bind(function(t, e, i) {
            var r = this.$config.rowStore;
            if (!r) return !0;
            var a = n.locateAttribute(t, this.$config.item_attribute);
            return (
              a && r.close(a.getAttribute(this.$config.item_attribute)), !1
            );
          }, this),
          this.$grid
        ),
          this._mouseDelegates.delegate(
            ...
            gantt.bind(function(t, e, i) {
              ...
              var a = n.locateAttribute(t, this.$config.item_attribute);
              return (
                a && r.open(a.getAttribute(this.$config.item_attribute)), !1
              );
            }, this),
            this.$grid
          );
      ...
      _getGridWidthLimits: function() {
        for (
          ...
          (i += e[r].min_width ? e[r].min_width : t.min_grid_column_width),
            void 0 !== n && (n = e[r].max_width ? n + e[r].max_width : void 0);
        return [i, n];
      },
      _setColumnsWidth: function(t, e) {
        ...
        for (var l = a - r, d = 0, s = 0; s < e + 1; s++) d += n[s].width;
        r -= d;
        for (var s = e + 1; s < n.length; s++) {
          var c = n[s],
            h = Math.round(l * (c.width / r));
          l < 0
            ? c.min_width && c.width + h < c.min_width
              ? (h = c.min_width - c.width)
              : !c.min_width &&
                i.min_grid_column_width &&
                c.width + h < i.min_grid_column_width &&
                (h = i.min_grid_column_width - c.width)
            : c.max_width &&
              c.width + h > c.max_width &&
              (h = c.max_width - c.width),
            (r -= c.width),
            (c.width += h),
            (l -= h);
        }
        for (
          ...
          for (s = e + 1; s < n.length; s++) {
            var g = n[s].width + u;
            if (
              (g == this._getColumnWidth(n[s], i, g) &&
                ((l -= u), (n[s].width = g)),
              !l)
            )
              break;
      ...
      _calculateGridWidth: function() {
        for (
          ...
          window.isNaN(s) && ((s = t.min_grid_column_width || 10), n.push(a)),
            (r[a] = s),
            (i += s);
        }
        ...
        if (t.autofit || n.length) {
          ...
          for (var a = 0; a < r.length; a++) e[a].width = r[a];
        } else {
          var u = o != i;
          (this.$config.width = i - 1),
            (t.grid_width = i),
            u &&
      ...
      _renderGridHeader: function() {
        ...
        e.rtl && (r = r.reverse());
        for (
          var a = [], s = 0, o = i.labels, l = e.scale_height - 1, d = 0;
          d < r.length;
          d++
        ) {
          var c = d == r.length - 1,
    ...
    function i(t) {
      ...
      return {
        delegate: function(i, n, r, a) {
          e.push([i, n, r, a]),
            t.$services.getService("mouseEvents").delegate(i, n, r, a);
        },
        destructor: function() {
          for (
            var i = t.$services.getService("mouseEvents"), n = 0;
            n < e.length;
            n++
          ) {
            var r = e[n];
    ...
    function n(t, e) {
      ...
      return {
        attach: function(e, n, r, a) {
          i.push({ element: e, event: n, callback: r, capture: a }),
            t(e, n, r, a);
        },
        ...
        detachAll: function() {
          for (var t = 0; t < i.length; t++)
            e(i[t].element, i[t].event, i[t].callback, i[t].capture),
              e(i[t].element, i[t].event, i[t].callback, void 0),
              e(i[t].element, i[t].event, i[t].callback, !1),
              e(i[t].element, i[t].event, i[t].callback, !0);
          i = [];
        },
        extend: function() {
    ...
    var n = i(3),
      ...
      s = (function(t) {
        ...
        function e(e, i, n) {
          ...
          return (
            e && (r.$root = !0), r._parseConfig(i), (r.$name = "layout"), r
          );
        }
        return (
          n(e, t),
              ...
              return (
                this._eachChild(function(t) {
                  t.$config.group &&
                    "scrollbar" != t.$name &&
                    "resizer" != t.$name &&
                    (i[t.$config.group] || (i[t.$config.group] = []),
                    i[t.$config.group].push(t));
                }),
                i[t] && this._syncGroupSize(i[t], e),
                i[t]
              );
            }
          }),
          (e.prototype._syncGroupSize = function(t, e) {
            if (t.length)
              for (
                var i = t[0].$parent._xLayout ? "width" : "height",
                  n = t[0].$parent.getNextSibling(t[0].$id) ? 1 : -1,
                  r = 0;
                r < t.length;
                r++
              ) {
                ...
                "resizer" == s.$name &&
                  (s =
                    n > 0
                      ? s.$parent.getNextSibling(s.$id)
                      : s.$parent.getPrevSibling(s.$id));
                var o = s.getSize();
                if (s[i]) {
                  var l = a.gravity + o.gravity,
                    d = a[i] + o[i],
                    c = l / d;
                  (t[r].$config.gravity = c * e),
                    (s.$config[i] = d - e),
                    (s.$config.gravity = l - c * e);
                } else t[r].$config[i] = e;
          ...
          (e.prototype.resize = function(e) {
            ...
            if (
              ...
              var n = [];
              (n = n.concat(this.getCellsByType("viewCell"))),
                (n = n.concat(this.getCellsByType("viewLayout"))),
                (n = n.concat(this.getCellsByType("hostCell")));
              for (
                var r = this.getCellsByType("scroller"), a = 0;
                a < n.length;
                a++
              )
              ...
              if (
                (this.$config.autosize &&
                  (this.autosize(this.$config.autosize), (o = !0)),
                o)
              ) {
                this.resize();
                for (var a = 0; a < n.length; a++)
          ...
          (e.prototype.moveView = function(t, e) {
            ...
            e >= i.childNodes.length
              ? i.appendChild(t.$view)
              : i.insertBefore(t.$view, i.childNodes[e]);
          }),
          (e.prototype._parseConfig = function(t) {
            (this.$cells = []), (this._xLayout = !t.rows);
            for (
              var e = t.rows || t.cols || t.views, i = 0;
              i < e.length;
              i++
            ) {
              var n = e[i];
          ...
          (e.prototype.$fill = function(t, e) {
            ...
            for (
              var i = r.getChildNodes(t, "gantt_layout_cell"), n = i.length - 1;
              n >= 0;
              n--
            ) {
              var a = this.$cells[n];
            ...
            for (var e, i, n, r = 0, a = 0, s = 0; s < this.$cells.length; s++)
              (i = this.$cells[s]),
                i.$config.hidden ||
                  ...
                  (n = i._getBorderSizes()),
                  this._xLayout
                    ? ((r += e.width + n.horizontal),
                      (a = Math.max(a, e.height + n.vertical)))
                    : ((r = Math.max(r, e.width + n.horizontal)),
                      (a += e.height + n.vertical)));
            return (
              (n = this._getBorderSizes()),
              (r += n.horizontal),
              (a += n.vertical),
              this.$root && ((r += 1), (a += 1)),
              { width: r, height: a }
          ...
          (e.prototype._getBoxStyles = function(t) {
            ...
            var i = [
              ...
              n = { boxSizing: "border-box" == e.boxSizing };
            ...
            return (
              a.borderBox
                ? ((a.innerWidth -= a.horPaddings),
                  (a.innerHeight -= a.vertPaddings))
                : ((a.outerWidth += a.horPaddings),
                  (a.outerHeight += a.vertPaddings)),
              a
            );
          }),
          ...
          (e.prototype.autosize = function(t) {
            var e = this._getAutosizeMode(t),
              ...
              r = this.$container;
            e.x &&
              (i.borderBox && (n.width += i.horPaddings),
              (r.style.width = n.width + "px")),
              e.y &&
                (i.borderBox && (n.height += i.vertPaddings),
                (r.style.height = n.height + "px"));
          }),
          (e.prototype.getSize = function() {
            this._sizes = [];
            for (
              var e = 0, i = 0, n = 1e5, r = 0, a = 1e5, s = 0, o = 0;
              o < this.$cells.length;
              o++
            ) {
              var l = (this._sizes[o] = this.$cells[o].getSize());
              this.$cells[o].$config.hidden ||
                (this._xLayout
                  ? (!l.width && l.minWidth
                      ? (e += l.minWidth)
                      : (e += l.width),
                    (n += l.maxWidth),
                    (i += l.minWidth),
                    (r = Math.max(r, l.height)),
                    (a = Math.min(a, l.maxHeight)),
                    (s = Math.max(s, l.minHeight)))
                  : (!l.height && l.minHeight
                    ...
                    (n = Math.min(n, l.maxWidth)),
                    (i = Math.max(i, l.minWidth))));
            }
            var d = t.prototype.getSize.call(this);
            return (
              d.maxWidth >= 1e5 && (d.maxWidth = n),
              d.maxHeight >= 1e5 && (d.maxHeight = a),
              (d.minWidth = d.minWidth !== d.minWidth ? 0 : d.minWidth),
              (d.minHeight = d.minHeight !== d.minHeight ? 0 : d.minHeight),
              this._xLayout
                ? ((d.minWidth +=
                    this.$config.margin * this.$cells.length || 0),
                  (d.minWidth += 2 * this.$config.padding || 0),
                  (d.minHeight += 2 * this.$config.padding || 0))
                : ((d.minHeight +=
                    this.$config.margin * this.$cells.length || 0),
                  (d.minHeight += 2 * this.$config.padding || 0)),
              d
          ...
          (e.prototype._calcFreeSpace = function(t, e, i) {
            ...
            return (
              a
                ? (a > r && (a = r), a < n && (a = n), (this._free -= a))
                : ((a = Math.floor(this._free / this._gravity * e.gravity)),
                  a > r &&
                    ((a = r), (this._free -= a), (this._gravity -= e.gravity)),
                  a < n &&
                    ((a = n), (this._free -= a), (this._gravity -= e.gravity))),
              a
            );
          }),
          (e.prototype._calcSize = function(t, e, i) {
            ...
            return (
              n || (n = Math.floor(this._free / this._gravity * e.gravity)),
              n > a && (n = a),
              n < r && (n = r),
              n
            );
          ...
          (e.prototype._configureBorders = function() {
            ...
            for (var n = 0; n < e.length; n++)
              if (!e[n].$config.hidden) {
                ...
                !r &&
                  e[n + 1] &&
                  "scrollbar" == e[n + 1].$config.view &&
                  (this._xLayout
                    ? (r = !0)
                    : (a = "gantt_layout_cell_border_transparent")),
                  this._setBorders(r ? [] : [t, a], e[n]);
              }
          }),
          (e.prototype._updateCellVisibility = function() {
            for (
              ...
              (t = this.$cells[r]),
                !i && t.$config.hidden && e[t.$id]
                  ? t._hide(!0)
                  : t.$config.hidden || e[t.$id] || t._hide(!1),
                t.$config.hidden || (n[t.$id] = !0);
          ...
          (e.prototype.setSize = function(e, i) {
            ...
            for (var s = 0; s < this._sizes.length; s++)
              if (((r = this.$cells[s]), !r.$config.hidden)) {
                ...
                s !== this.$cells.length - 1 &&
                  ((l.style[d] = o + "px"), (this._free -= o)),
                  (a = this._sizes[s]),
                  this._xLayout
                    ? a.width || (this._gravity += a.gravity)
                    : a.height || (this._gravity += a.gravity);
              }
            for (var s = 0; s < this._sizes.length; s++)
              if (((r = this.$cells[s]), !r.$config.hidden)) {
                a = this._sizes[s];
                var c = a.width,
                  h = a.height;
                this._xLayout
                  ? this._calcFreeSpace(c, a, !0)
                  : this._calcFreeSpace(h, a, !1);
              }
            for (var s = 0; s < this.$cells.length; s++)
              if (((r = this.$cells[s]), !r.$config.hidden)) {
                ...
                var u = void 0,
                  _ = void 0;
                this._xLayout
                  ? ((u = this._calcSize(a.width, a, !0)), (_ = i - 2 * n))
                  : ((u = e - 2 * n), (_ = this._calcSize(a.height, a, !1))),
                  r.setSize(u, _);
              }
          }),
          e
  ...
  function(t, e, i) {
    function n(t, e) {
      for (var i, n, r, a = 0, s = t.length - 1; a <= s; )
        if (
          ((i = Math.floor((a + s) / 2)), (n = +t[i]), (r = +t[i - 1]), n < e)
        )
          a = i + 1;
        else {
          if (!(n > e)) {
    ...
    var r = i(14),
      ...
      o = i(47),
      l = function(t, e, i, n) {
        (this.$config = s.mixin({}, e || {})),
          (this.$scaleHelper = new r(n)),
          (this.$gantt = n),
          a(this);
      };
    (l.prototype = {
      init: function(t) {
        ...
        !i && this.$config.bind && (i = this.$config.bind + "_id"),
          !n && this.$config.bindLinks && (n = this.$config.bindLinks + "_id"),
          (this.$config.item_attribute = i || null),
          (this.$config.link_attribute = n || null);
      ...
      setSize: function(t, e) {
        ...
        if (
          ...
          i.smart_rendering && this.$config.rowStore)
        ) {
          var r = this.$config.rowStore;
        ...
        for (
          ...
          var d = s[o];
          d.hasAttribute("data-layer") &&
            d.style &&
            (d.style.width = a.full_width + "px");
        }
      },
      isVisible: function() {
        return this.$parent && this.$parent.$config
        ...
        if (this.$config.bind) {
          ...
          for (var r = this.$config.layers, a = 0; r && a < r.length; a++) {
            ...
            "string" == typeof s && (s = this.$gantt.$ui.layers[s]),
              "function" == typeof s && (s = { renderer: s }),
              (s.host = this);
            var o = n.addLayer(s);
            this._taskLayers.push(o),
              s.expose && (this._taskRenderer = n.getLayer(o));
          }
        ...
        if (this.$config.bindLinks) {
          ...
          for (var d = this.$config.linkLayers, a = 0; d && a < d.length; a++) {
            ...
            this._taskLayers.push(c),
              d[a].expose && (this._linkRenderer = l.getLayer(c));
          }
        }
      },
      _initStaticBackgroundRender: function() {
        var t = this,
          ...
          i = t.$config.rowStore;
        i &&
          ((this._staticBgHandler = i.attachEvent("onStoreUpdated", function(
            i,
            n,
            r
          ) {
      ...
      _render_tasks_scales: function() {
        ...
        (this.$task_scale.style.height = n),
          (this.$task_data.style.width = this.$task_scale.style.width = i),
          (this.$task_scale.innerHTML = e);
      },
      _getScaleChunkHtml: function(t, e, i) {
        for (
          var n = this.$gantt.$services.templates(),
            r = [],
            a = n.scale_row_class,
            s = 0;
          s < t.length;
          ...
          l && (o += " " + l),
            r.push(
              '<div class="' +
                ...
                t[s].height +
                'px">' +
                this._prepareScaleHtml(t[s], e, i) +
                "</div>"
            );
        }
        return r.join("");
      ...
      _prepareScaleHtml: function(t, e, i) {
        var r = this.$getConfig(),
          ...
          d = null;
        (t.template || t.date) &&
          (l = t.template || this.$gantt.date.date_to_str(t.date));
        var c = 0,
          h = t.count;
        !r.smart_scales ||
          isNaN(e) ||
          isNaN(i) ||
          ((c = n(t.left, e)), (h = n(t.left, i) + 1)),
          (d = t.css || function() {}),
          !t.css && r.inherit_scale_class && (d = a.scale_cell_class);
        for (var u = c; u < h && t.trace_x[u]; u++) {
          ...
          if (g) {
            (v =
              ...
              f +
              "px;" +
              (r.smart_scales ? "position:absolute;left:" + p + "px" : "")),
              (k =
                "gantt_scale_cell" +
                (u == t.count - 1 ? " gantt_last_cell" : "")),
              (m = d.call(this, o)),
              m && (k += " " + m);
      ...
      dateFromPos: function(t) {
        ...
        var o = 0;
        return (
          s && (o = this._getColumnDuration(e, e.trace_x[i])),
          new Date(e.trace_x[i].valueOf() + Math.round(s * o))
        );
      },
      ...
      columnIndexByDate: function(t) {
        ...
        if (e <= a.min_date) return this._tasks.rtl ? i.length : 0;
        if (e >= a.max_date) return this._tasks.rtl ? 0 : i.length;
        for (var s = n(i, e), o = +i[s]; r[o]; ) o = i[++s];
        ...
        return (
          this._tasks.rtl
            ? ((r = this.posFromDate(e || t.start_date)),
              (n = this.posFromDate(i || t.end_date)))
            : ((n = this.posFromDate(e || t.start_date)),
              (r = this.posFromDate(i || t.end_date))),
          (a = Math.max(r - n, 0)),
          {
            left: n,
    ...
    var n = i(17),
      ...
      s = function(t) {
        return (
          ...
          (this.visibleOrder = n.$create()),
          (this.fullOrder = n.$create()),
    ...
    (s.prototype = {
          ...
          (e = t[n]),
            ...
            this.callEvent("onItemLoading", [e]) &&
              (this.pull.hasOwnProperty(e.id) ||
                (this.fullOrder.push(e.id), i.push(e)),
              (this.pull[e.id] = e));
        return i;
      },
      parse: function(t) {
      ...
      _changeIdInner: function(t, e) {
        this.pull[t] && (this.pull[e] = this.pull[t]),
          ...
          (this._searchVisibleOrder[e] = this._searchVisibleOrder[t]),
      ...
      move: function(t, e) {
        ...
        this._moveInner(t, e),
          this._skip_refresh ||
            this.callEvent("onStoreUpdated", [n.id, n, "move"]);
      },
      clearAll: function() {
        (this.pull = {}),
          (this.visibleOrder = n.$create()),
        ...
        if (!this._skip_refresh) {
          if (t) {
            if (!e) {
              var i = this.visibleOrder;
              this.filter(),
                this.arraysEqual(i, this.visibleOrder) || (t = void 0);
            }
          } else this.filter();
          t
            ? this.callEvent("onStoreUpdated", [t, this.pull[t], "paint"])
    ...
    var n = i(17),
      ...
      o = function(t) {
        return (
          ...
          "function" != typeof t.rootId
            ? (this.$getRootId = (function(t) {
                return function() {
                  return t;
                };
              })(t.rootId || 0))
          ...
          (this._skip_refresh = !1),
          a(this),
          this.attachEvent("onFilterItem", function(t, e) {
            var i = !0;
            return (
    ...
    (o.prototype = r.mixin(
      {
        _buildTree: function(t) {
          for (
            var e = null, i = this.$getRootId(), n = 0, a = t.length;
            n < a;
            n++
          )
          ...
          for (var n = 0, a = t.length; n < a; n++)
            (e = t[n]),
              ...
              r.defined(e.$open) ||
                (e.$open = r.defined(e.open) ? e.open : this.$openInitially());
          this._updateOrder();
        },
        parse: function(t) {
          this.callEvent("onBeforeParse", [t]);
        ...
        _addItemInner: function(t, e) {
          ...
          1 * a !== a && (a = void 0),
            s.prototype._addItemInner.call(this, t, a),
            this.setParent(t, i),
        ...
        _removeItemInner: function(t) {
          ...
          for (var i = 0; i < e.length; i++)
            this._move_branch(e[i], this.getParent(e[i]), null),
              s.prototype._removeItemInner.call(this, e[i].id),
              this._move_branch(e[i], this.getParent(e[i]), null);
        },
        move: function(t, e, i) {
          var n = arguments[3];
          ...
          if (t != i) {
            ...
            if (!1 !== this.callEvent("onBeforeItemMove", [t, i, e])) {
              ...
              (r.$level += o),
                ...
                this._moveInner(this.getIndexById(t), this.getIndexById(i) + e),
                this.callEvent("onAfterItemMove", [t, i, e]),
                this.refresh();
            }
          }
        },
        getBranchIndex: function(t) {
          for (
            var e = this.getChildren(this.getParent(t)), i = 0;
            i < e.length;
            i++
          )
            if (e[i] == t) return i;
        ...
        _setParentInner: function(t, e, i) {
          i ||
            (t.hasOwnProperty("$rendered_parent")
              ? this._move_branch(t, t.$rendered_parent, e)
              : this._move_branch(t, t[this.$parentProperty], e));
        },
        ...
        _add_branch: function(t, e, i) {
          ...
          for (
            var a = this.getChildren(r), s = !1, o = 0, l = a.length;
            o < l;
            o++
          )
            if (a[o] == t.id) {
          ...
          s ||
            (1 * e == e ? a.splice(e, 0, t.id) : a.push(t.id),
            (t.$rendered_parent = r));
        },
        _move_branch: function(t, e, i) {
          this._replace_branch_child(e, t.id),
            this.exists(i) || i == this.$getRootId()
              ? this._add_branch(t, void 0, i)
        ...
        filter: function(t) {
          for (var e in this.pull)
            this.pull[e].$rendered_parent !== this.getParent(this.pull[e]) &&
              this._move_branch(
                this.pull[e],
                this.pull[e].$rendered_parent,
                this.getParent(this.pull[e])
              );
          return s.prototype.filter.apply(this, arguments);
        },
        open: function(t) {
          this.exists(t) &&
            ((this.getItem(t).$open = !0), this.callEvent("onItemOpen", [t]));
        },
        close: function(t) {
          this.exists(t) &&
            ((this.getItem(t).$open = !1), this.callEvent("onItemClose", [t]));
        },
        destructor: function() {
  ...
  function(t, e, i) {
    ...
    function o(t) {
      ...
      (l.start_date && l.end_date) ||
        ((l = n(t)),
        (l.start_date && l.end_date) || (l = r(t)),
        (l.start_date = t.date[i + "_start"](l.start_date)),
        (l.start_date = t.calculateEndDate({
          start_date: t.date[i + "_start"](l.start_date),
          duration: -1,
          unit: i,
          step: o
        })),
        (l.end_date = t.date[i + "_start"](l.end_date)),
        (l.end_date = t.calculateEndDate({
          start_date: l.end_date,
          duration: 2,
          unit: i,
          step: o
        }))),
        (t._min_date = l.start_date),
        (t._max_date = l.end_date);
    }
    function l(t) {
  ...
  function(t, e) {
    ...
    function r(t, e) {
      var i = {};
      return (
        t.isTaskExists(e) && n(t, t.getTask(e), i),
    ...
    t.exports = { getSubtreeLinks: r, getSubtreeTasks: a };
  },
  function(t, e, i) {
    var n = i(0),
      r = i(4),
            ...
            return (
              e.date
                ? ((e = n.mixin({}, e)),
                  ...
                  (e.task = e.task || null),
                  (e.calendar = e.calendar || null))
                : ((e = {}),
                  (e.date = arguments[0]),
                  (e.unit = arguments[1]),
                  (e.task = arguments[2]),
                  (e.calendar = arguments[3])),
              (e.unit = e.unit || t.config.duration_unit),
              e
            );
          },
          ...
          _getStartEndConfig: function(e) {
            ...
            return e instanceof n
              ...
              : (r.isDate(e)
                  ...
                  : ((i = new n(e.start_date, e.end_date, e.task)),
                    e.id && (i.task = e)),
                (i.unit = i.unit || t.config.duration_unit),
                (i.step = i.step || t.config.duration_step),
                (i.start_date = i.start_date || i.start || i.date),
                i);
          },
          ...
          calculateEndDateArguments: function(e, i, a, s) {
            ...
            return (
              (o = r.isDate(o)
                ...
                : n.mixin({}, o)),
              (o.unit = o.unit || t.config.duration_unit),
              (o.step = o.step || t.config.duration_step),
              o
            );
          }
        };
  ...
  function(t, e, i) {
    (window.Gantt = i(24)), (window.gantt = window.Gantt.getGanttInstance());
  },
  function(t, e, i) {
    var n = { _seed: 0 };
    (n.plugin = function(t) {
      ...
      (n._ganttPlugin = []),
      (n.getGanttInstance = function() {
        for (var t = i(25)(), e = 0; e < n._ganttPlugin.length; e++)
          n._ganttPlugin[e](t);
        return (
          (t._internal_id = n._seed++),
          n.$syncFactory && n.$syncFactory(t),
          i(110)(t),
          t
        );
      }),
  ...
  function(t, e, i) {
    function n() {
      (this.version = "5.1.2"),
        (this.templates = {}),
        (this.keys = { edit_save: 13, edit_cancel: 27 });
    }
    t.exports = function() {
      var t = new n();
      i(26)(t),
        (t.$services = t.$inject(i(27))),
        (t.config = t.$inject(i(28))),
        (t.ajax = i(29)(t)),
        (t.date = i(30)(t));
      var e = i(31)(t);
      ...
      s.registerProvider("global", function() {
        ...
        (t.getState = s.getState),
        t.$services.setService("state", function() {
          return s;
        });
      var o = i(0);
      ...
      var l = i(11)();
      (t.event = l.attach),
        (t.eventRemove = l.detach),
        (t._eventRemoveAll = l.detachAll),
        (t._createDomEventScope = l.extend),
        o.mixin(t, i(34)(t));
      var d = i(35).init(t);
      (t.$ui = d.factory),
        (t.$ui.layers = d.render),
        (t.$mouseEvents = d.mouseEvents),
        t.$services.setService("mouseEvents", function() {
          return t.$mouseEvents;
        }),
        t.mixin(t, d.layersApi),
        i(61)(t),
    ...
    t.exports = function(t) {
      return {
        ...
        xmltop: function(e, i, n) {
          ...
          return (
            -1 !== n &&
              t.callEvent("onLoadXMLError", ["Incorrect XML", arguments[1], n]),
        ...
        post: function(t, e, i) {
          1 == arguments.length
            ? (e = "")
            : 2 != arguments.length ||
              ("function" != typeof e && "function" != typeof window[e])
              ? (e = String(e))
              : ((i = e), (e = "")),
        ...
        postSync: function(t, e) {
          return (
            (e = null === e ? "" : String(e)), this._call("POST", t, e, !1)
          );
        },
              ...
              (d.onreadystatechange = function() {
                if (4 == d.readyState || (c && 3 == d.readyState)) {
                  ...
                  window.setTimeout(function() {
                    "function" == typeof s &&
                      s.apply(window, [{ xmlDoc: d, filePath: i }]),
                      o &&
                        (void 0 !== o.postData
                          ? this.postLong(o.url, o.postData, s)
                          : this.getLong(o.url, s)),
                      (s = null),
                      (d = null);
                  }, 1);
                }
    ...
    t.exports = function(t) {
      var e = {
        init: function() {
          for (
            var e = t.locale,
              i = e.date.month_short,
              n = (e.date.month_short_hash = {}),
              r = 0;
            r < i.length;
            r++
          )
            n[i[r]] = r;
          for (
            var i = e.date.month_full, n = (e.date.month_full_hash = {}), r = 0;
            r < i.length;
            r++
          )
            n[i[r]] = r;
        ...
        week_start: function(e) {
          var i = e.getDay();
          return (
            t.config.start_on_monday && (0 === i ? (i = 6) : i--),
        ...
        quarter_start: function(t) {
          ...
          var e,
            i = t.getMonth();
          return (
            (e = i >= 9 ? 9 : i >= 6 ? 6 : i >= 3 ? 3 : 0), t.setMonth(e), t
          );
        },
        ...
        str_to_date: function(e, i) {
          for (
            var n = "var temp=date.match(/[a-zA-Z]+|[0-9]+/g);",
              r = e.match(/%[a-zA-Z]/g),
              a = 0;
            a < r.length;
            a++
          ...
          var o = new Function(
            "date",
            "locale",
            "var set=[0,0,1,0,0,0]; " + n + " return new Date(" + s + ");"
          );
          return function(e) {
            return o(e, t.locale);
          };
          ...
          return (
            e &&
              ...
              (t.defined(i) &&
                (i =
                  "string" == typeof i
                    ? t.defined(t.templates[i])
                      ? t.templates[i]
                      : t.date.str_to_date(i)
        ...
        for (var o = 0; o < s.length; o++)
          r.bind(function(n) {
            t.event(
              ...
              r.bind(function(a) {
                n.accessor(a) &&
                  ((this._settings.original_target = e(a)),
                  t.config.touch
                    ? (this.clearDragTimer(),
        ...
        (i.prototype = {
          traceDragEvents: function(e, i) {
            var n = r.bind(function(t) {
              ...
              o = r.bind(function(n) {
                return (
                  t.eventRemove(document.body, i.move, s),
                  t.eventRemove(document.body, i.up, o),
                  this.dragEnd(e)
                );
              }, this);
          ...
          checkPositionChange: function(t) {
            ...
            return (
              Math.sqrt(Math.pow(Math.abs(e), 2) + Math.pow(Math.abs(i), 2)) >
          ...
          backupEventTarget: function(i, n) {
            if (t.config.touch) {
              ...
              (this.config.original_target = e(r)),
                (this.config.original_target.target = s),
          ...
          dragStart: function(e, i, n) {
            (this.config = {
              ...
              this._settings && r.mixin(this.config, this._settings, !0),
  ...
  function(t, e) {
    t.exports = function(t) {
      function e(e, i, r) {
        ...
        t.config[e] &&
          n[r] != a[e] &&
          ((i && s[r]) || ((s[r] = t.date.date_to_str(a[e])), (n[r] = a[e])));
      }
      function i() {
        var i = t.locale.labels;
        (i.gantt_save_btn = i.icon_save),
          (i.gantt_cancel_btn = i.icon_cancel),
          (i.gantt_delete_btn = i.icon_delete);
        var n = t.date,
          r = n.date_to_str,
          a = t.config;
        e("date_scale", !0, void 0, t.config, t.templates),
          e("date_grid", !0, "grid_date_format", t.config, t.templates),
          e("task_date", !0, void 0, t.config, t.templates),
          t.mixin(t.templates, {
            ...
            date_grid: function(e, i) {
              return i && t.isUnscheduledTask(i) && t.config.show_unscheduled
                ? t.templates.task_unscheduled_time(i)
                : t.templates.grid_date_format(e);
            },
            task_time: function(e, i, n) {
              return t.isUnscheduledTask(n) && t.config.show_unscheduled
                ? t.templates.task_unscheduled_time(n)
                : t.templates.task_date(e) + " - " + t.templates.task_date(i);
            },
            ...
            tooltip_text: function(e, i, n) {
              return (
                ...
                "<br/><b>End date:</b> " +
                t.templates.tooltip_date_format(i)
              );
            }
          });
      }
      var n = {};
      return { initTemplates: i, initTemplate: e };
    };
  },
  function(t, e, i) {
    var n = i(0),
      r = function() {
        function t(t) {
          if (t) return r[t].method();
          var e = {};
          for (var i in r) r[i].internal || n.mixin(e, r[i].method(), !0);
          return e;
        }
        function e(t, e, i) {
          r[t] = { method: e, internal: i };
        }
        function i(t) {
          delete r[t];
        }
        var r = {};
        return { getState: t, registerProvider: e, unregisterProvider: i };
      };
    t.exports = r;
  },
  function(t, e, i) {
    ...
    t.exports = function(t) {
        ...
        if (p) {
          ...
          if (b.keyboard) {
            if (13 == i || 32 == i) {
              ...
              y.getClassName(r).indexOf("gantt_popup_button") > -1 && r.click
                ? r.click()
                : (e(p, !0), (n = !0));
            }
            27 == i && (e(p, !1), (n = !0));
      ...
      function a(t) {
        a.cover ||
          ((a.cover = document.createElement("DIV")),
          (a.cover.onkeydown = r),
          (a.cover.className = "dhx_modal_cover"),
          document.body.appendChild(a.cover));
      ...
      function o(e) {
        b.area ||
          ((b.area = document.createElement("DIV")),
          (b.area.className = "gantt_message_area dhtmlx_message_area"),
          (b.area.style[b.position] = "5px"),
          document.body.appendChild(b.area)),
          b.hide(e.id);
        var i = document.createElement("DIV");
        return (
          (i.innerHTML = "<div>" + e.text + "</div>"),
          (i.className =
            "gantt-info dhtmlx-info gantt-" + e.type + " dhtmlx-" + e.type),
          (i.onclick = function() {
            b.hide(e.id), (e = null);
          }),
          t._waiAria.messageInfoAttr(i),
          "bottom" == b.position && b.area.firstChild
            ? b.area.insertBefore(i, b.area.firstChild)
            : b.area.appendChild(i),
          e.expire > 0 &&
            (b.timers[e.id] = window.setTimeout(function() {
              b.hide(e.id);
            }, e.expire)),
          (b.pull[e.id] = i),
          (i = null),
      ...
      function d(i, r, a) {
        ...
        if (
          ...
          r && (c += s(l(i.ok, t.locale.labels.message_ok, "OK"), "ok", !0)),
          a &&
            (c += s(
              l(i.cancel, t.locale.labels.message_cancel, "Cancel"),
              "cancel",
              !1
            )),
          i.buttons)
        ...
        if (((c += "</div>"), (o.innerHTML = c), i.content)) {
          ...
          "string" == typeof v && (v = document.getElementById(v)),
            ...
            o.childNodes[i.title ? 1 : 0].appendChild(v);
        }
        return (
          (o.onclick = function(t) {
            ...
            if (
              ...
              "gantt_popup_button" == n.className.split(" ")[0])
            ) {
      ...
      function g(t, e, i) {
        return (
          "object" != typeof t &&
            ...
            (t = { text: t, type: e, callback: i })),
          t
        );
      }
      function f(t, e, i, r) {
        return (
          "object" != typeof t && (t = { text: t, type: e, expire: i, id: r }),
          (t.id = t.id || n.uid()),
          (t.expire = t.expire || b.expire),
          t
        );
      }
      var p = null;
      ...
      k.hide = function(e) {
        ...
        e &&
          ...
          a(!1),
          t.callEvent("onAfterMessagePopup", [e]));
      };
      var y = i(1);
      k.focus = function(t) {
        setTimeout(function() {
      ...
      (b.seed = new Date().valueOf()),
        ...
        (b.hide = function(t) {
          ...
          e &&
            ...
            (e.className += " hidden"),
            b.timers[t] && window.clearTimeout(b.timers[t]),
            delete b.pull[t]);
        });
      var $ = [];
      return (
        ...
        t.attachEvent("onDestroy", function() {
          a.cover &&
            a.cover.parentNode &&
            a.cover.parentNode.removeChild(a.cover);
          for (var t = 0; t < $.length; t++)
            $[t].parentNode && $[t].parentNode.removeChild($[t]);
          ($ = null),
            b.area &&
              b.area.parentNode &&
              b.area.parentNode.removeChild(b.area),
            (b = null);
        }),
        { alert: v, confirm: m, message: b, modalbox: k }
      );
    };
  },
  function(t, e, i) {
    function n(t) {
      ...
      i.registerView("cell", o),
        i.registerView("resizer", h),
        i.registerView("scrollbar", u),
        i.registerView("layout", l, function(t) {
          "main" === (t.$config ? t.$config.id : null) && e(t, w);
        }),
        i.registerView("viewcell", c),
        i.registerView("multiview", d),
        i.registerView("timeline", _, function(t) {
        ...
        i.registerView("resourceGrid", f),
        i.registerView("resourceTimeline", p);
      var n = s(t);
      return {
        factory: i,
        mouseEvents: a.init(t),
        layersApi: n.init(),
        render: { gridLine: y(t), taskBg: m(t), taskBar: v(t), link: k(t) },
        layersService: {
  ...
  function(t, e, i) {
    var n = i(0),
      ...
      a = function(t) {
        ...
        function i(e, i, a, s) {
          var o = l[e];
          if (!o || !o.create) return !1;
          "resizer" != e ||
            a.mode ||
            (s.$config.cols ? (a.mode = "x") : (a.mode = "y")),
            "viewcell" != e ||
              "scrollbar" != a.view ||
              a.scroll ||
              (s.$config.cols ? (a.scroll = "y") : (a.scroll = "x"));
          var a = n.copy(a);
          a.id || d[a.view] || (a.id = a.view),
            a.id && !a.css && (a.css = a.id + "_cell");
          var c = new o.create(i, a, this, t);
          return (
            o.configure && o.configure(c),
            r(c, s),
            c.$id || (c.$id = a.id || t.uid()),
            c.$parent || "object" != typeof i || (c.$parent = i),
            c.$config || (c.$config = a),
            d[c.$id] && (c.$id = t.uid()),
            (d[c.$id] = c),
            c
  ...
  function(t, e, i) {
    ...
    function r(t, e) {
      ...
      return i
        ? i instanceof n
          ? i
          : ((n.prototype = e), (this.$config[t] = new n(i)), this.$config[t])
        : e;
    }
    var a = i(0),
      s = function(t) {
        ...
        return {
          $getConfig: function() {
            return (
              ...
              r.call(this, "config", e)
            );
          },
          $getTemplates: function() {
            return (
              i || (i = t ? t.$getTemplates() : this.$gantt.templates),
              r.call(this, "templates", i)
            );
          }
        };
      };
  ...
  function(t, e, i) {
    var n = i(1),
      r = (function(t) {
        return function(e) {
          function i(t, e, i, n) {
            u[t][e] || (u[t][e] = []), u[t][e].push({ handler: i, root: n });
          }
          function n(t, e, i, n) {
            var r = u[t][e];
            if (r)
              for (var a = 0; a < r.length; a++)
                ((i || r[a].root) && r[a].root !== i) ||
                  r[a].handler.apply(this, n);
          }
          function r(t) {
            t = t || window.event;
          ...
          function a(t) {
            ...
            var i = t.target || t.srcElement,
              ...
              a =
                ...
                e.callEvent("onContextMenu", [n, r, t]);
            return (
              a ||
                ...
                for (var s = 0; s < a.length; s++)
                  if (a[s] && i[a[s]])
                    for (var o = i[a[s]], l = 0; l < o.length; l++)
                      (o[l].root && !t.isChildOf(n, o[l].root)) ||
                        r.push(o[l].handler);
              }
              n = n.parentNode;
            }
          ...
          function l(t) {
            ...
            var i = (t.target || t.srcElement, e.locate(t)),
              ...
              r =
                ...
                e.callEvent("onTaskDblClick", [i, t]);
            if (r) {
              if (!o(n, t, i)) return;
              null !== i &&
                e.getTask(i) &&
          ...
          function h(t) {
            _.detachAll(),
              t &&
                (_.attach(t, "click", r),
                _.attach(t, "dblclick", l),
                _.attach(t, "mousemove", d),
                _.attach(t, "contextmenu", a));
          }
          var u = { click: {}, doubleclick: {}, contextMenu: {} },
      ...
      r = function(t) {
        ...
        return {
          ...
          createDataRender: function(i) {
            ...
            return (
              t.$services.setService("layer:" + n, function() {
                return s;
              }),
          ...
          createGroup: function(i, r, o) {
            var l = {
              ...
              _add: function(t) {
                ...
                for (
                  var i = this.container(), n = this.tempCollection, o = 0;
                  o < n.length;
                  o++
                )
                  if (
                    ...
                    this.container() ||
                      (t &&
                        t.container &&
                        s.isChildOf(t.container, document.body)))
                  ) {
                    var l = t.container,
                      d = t.id,
                      c = t.topmost;
                    ...
                    (this.renderers[d] = e.getRenderer(d, t, l)),
                      this.tempCollection.splice(o, 1),
                      o--;
                  }
              },
              addLayer: function(t) {
                return (
                  t &&
                    ("function" == typeof t && (t = { renderer: t }),
                    void 0 === t.filter
                      ? (t.filter = n(o || []))
                      : t.filter instanceof Array &&
                        (t.filter.push(o), (t.filter = n(t.filter))),
                    t.container ||
              ...
              removeLayer: function(t) {
                this.renderers[t] &&
                  (this.renderers[t].destructor(), delete this.renderers[t]);
              },
              clear: function() {
    ...
    var i = function(t) {
      function e(e, i, s) {
        ...
        var o = function(t) {
          ...
          l = i.filter;
        return (
          s && s.setAttribute(n.config().layer_attribute, !0),
          (a[e] = {
      ...
      function i() {
        for (var t in a) e(t).destructor();
      }
      var n = t.$services,
        r = {},
        a = {};
      return { getRenderer: e, clearRenderers: i };
    };
    t.exports = i;
  },
  function(t, e, i) {
    var n = i(3),
      ...
      s = (function(t) {
        ...
        function e(e, i, n) {
          for (
            var r = t.apply(this, arguments) || this, a = 0;
            a < r.$cells.length;
            a++
          )
        ...
        return (
          ...
          (e.prototype.getContentSize = function() {
            ...
            if (this.$content && this.$initialized) {
              ...
              (e.width = void 0 === i.contentX ? i.width : i.contentX),
                (e.height = void 0 === i.contentY ? i.height : i.contentY);
            }
        ...
        function e(e, i, n) {
          ...
          return (
            ...
            (s._clearListeneres = function() {
              this.$domEvents.detach(document, "mouseup", s._upHandler),
                this.$domEvents.detach(document, "mousemove", s._moveHandler),
                this.$domEvents.detach(document, "mousemove", s._startOnMove),
                this.$domEvents.detach(document, "mouseup", s._cancelDND);
            }),
              ...
              if (
                (this._xMode
                  ? ((r =
                    ...
                    (a =
                      this._front.$config.width ||
                      this._front.$view.offsetWidth))
                  : ((r =
                ...
                !1 === s.callEvent("onResizeStart", [r, a]))
              )
                return !1;
            }),
            (s._startDND = function(t) {
              if (!1 !== this._callStartDNDEvent()) {
                ...
                this._eachGroupItem(function(t) {
                  ...
                  e ||
                    (s._moveHandler(t),
                    s.$domEvents.attach(document, "mousemove", s._moveHandler),
                    s.$domEvents.attach(document, "mouseup", s._upHandler));
              }
            }),
            ...
            (s._downHandler = function(t) {
              s._getSiblings(),
                s._behind.$config.collapsed ||
                  s._front.$config.collapsed ||
                  (s._setBackground(!0),
                  (s._resizer = s._setResizer()),
                  (s._positions = {
                    x: t.pageX,
                    y: t.pageY,
                    timestamp: Date.now()
                  }),
                  s.$domEvents.attach(document, "mousemove", s._startOnMove),
                  s.$domEvents.attach(document, "mouseup", s._cancelDND));
            }),
            (s.$name = "resizer"),
            s
          );
        ...
        return (
          ...
          (e.prototype.init = function() {
            ...
            t.prototype.init.call(this),
              (this._xMode = "x" === this.$config.mode),
          ...
          (e.prototype._isPosChanged = function(t) {
            return (
              !!this._positions &&
              (Math.abs(this._positions.x - t.pageX) > 3 ||
                Math.abs(this._positions.y - t.pageY) > 3 ||
          ...
          (e.prototype._getSiblings = function() {
            ...
            this.$config.prev &&
              ...
              this._behind instanceof s ||
                (this._behind = this._behind.$parent)),
              this.$config.next &&
                ((this._front = this.$factory.getView(this.$config.next)),
                this._front instanceof s ||
                  (this._front = this._behind.$parent));
            for (var e = 0; e < t.length; e++)
              this === t[e] &&
                (this._behind || (this._behind = t[e - 1]),
                this._front || (this._front = t[e + 1]));
          }),
          (e.prototype._setBackground = function(t) {
            var e = "gantt_resizing";
            if (!t)
              return (
                r.removeClassName(this._behind.$view, e),
                r.removeClassName(this._front.$view, e),
                void r.removeClassName(document.body, "gantt_noselect")
              );
            r.addClassName(this._behind.$view, e, !0),
              r.addClassName(this._front.$view, e, !0),
              r.addClassName(document.body, "gantt_noselect", !0);
          }),
          (e.prototype._setResizer = function() {
            var t = document.createElement("div");
            return (
              (t.className = "gantt_resizer_stick"),
              this.$view.appendChild(t),
              (this.$view.style.overflow = "visible"),
              (t.style.height = this.$view.style.height),
              t
            );
          }),
          (e.prototype._getDirection = function(t, e) {
            var i;
            return (
              (i = this._xMode ? t - this._positions.x : e - this._positions.y),
              i ? (i < 0 ? -1 : 1) : 0
            );
          }),
          (e.prototype._getResizePosition = function(t, e) {
            ...
            this._xMode
              ? ((i = t - this._positions.x),
                ...
                (s = this._front.$config.minWidth))
              : ((i = e - this._positions.y),
                (n =
                  this._behind.$config.height ||
                  this._behind.$view.offsetHeight),
                (a =
            ...
            var o,
              l,
              d = this._getDirection(t, e);
            if (-1 === d) {
              if (
                ((l = a - i),
                (o = n - Math.abs(i)),
                a - i > this._front.$config.maxWidth)
              )
                return;
              Math.abs(i) >= n && (i = -Math.abs(n - 2)),
                n - Math.abs(i) <= r && (i = -Math.abs(n - r));
            } else
              (l = a - Math.abs(i)),
                (o = n + i),
                n + i > this._behind.$config.maxWidth &&
                  (i = this._behind.$config.maxWidth - n),
                Math.abs(i) >= a && (i = a - 2),
                a - Math.abs(i) <= s && (i = Math.abs(a - s));
            return (
              -1 === d
                ? ((l = a - i), (o = n - Math.abs(i)))
                : ((l = a - Math.abs(i)), (o = n + i)),
              { size: i, newFrontSide: l, newBehindSide: o }
            );
          }),
          ...
          (e.prototype._eachGroupItem = function(t, e) {
            for (
              var i = this.$factory.getView("main"),
                n = this._getGroupName(),
                r = i.getCellsByType("resizer"),
                a = 0;
              a < r.length;
              a++
            )
          ...
          (e.prototype._getGroupResizePosition = function(t, e) {
            ...
            this._eachGroupItem(function(i) {
              ...
              this._xMode
                ? (r.x += i._behind.$config.width - this._behind.$config.width)
                : (r.y +=
                    i._behind.$config.height - this._behind.$config.height),
                (i._positions = r),
                n.push(i._getResizePosition(t, e));
            });
            for (var r, s = 0; s < n.length; s++) {
              if (!n[s]) return;
              void 0 === r
                ? (r = n[s])
                : n[s].newBehindSide > r.newBehindSide && (r = n[s]);
            }
            return r;
          }),
          (e.prototype._moveResizer = function(t, e, i) {
            if (0 !== e) {
              ...
              n &&
                1 !== Math.abs(n.size) &&
                (this._xMode
                  ? ((t.style.left = n.size + "px"),
                    (this._positions.nextX = n.size || 0))
                  : ((t.style.top = n.size + "px"),
                    (this._positions.nextY = n.size || 0)),
                this.callEvent("onResize", [n.newBehindSide, n.newFrontSide]));
            }
          }),
          (e.prototype._setGravity = function(t) {
            var e = this._xMode ? "offsetWidth" : "offsetHeight",
              ...
              o = (n - i) / n * a,
              l = (r + i) / r * s;
            "front" !== t && (this._front.$config.gravity = o),
              "behind" !== t && (this._behind.$config.gravity = l);
          }),
          (e.prototype._getNewSizes = function() {
            var t = this._xMode
              ...
              i = this._xMode ? this._positions.nextX : this._positions.nextY;
            return e || t
              ? { front: e ? e - i || 1 : 0, back: t ? t + i || 1 : 0 }
              : null;
          }),
          (e.prototype._assignNewSizes = function(t) {
            ...
            t
              ? (t.front
                  ? (this._front.$config[e] = t.front)
                  : this._setGravity("behind"),
                t.back
                  ? (this._behind.$config[e] = t.back)
            ...
            if (this._positions.nextX || this._positions.nextY) {
              ...
              this._front.$config.group
                ? this.$gantt.$layout._syncCellSizes(
                    this._front.$config.group,
                    this._front.$config[e]
                  )
                : this._behind.$config.group &&
                  this.$gantt.$layout._syncCellSizes(
                    this._behind.$config.group,
                    this._behind.$config[e]
                  ),
                this._getGroupName()
    ...
    var n = i(3),
      ...
      l = (function(t) {
        ...
        function e(e, i, n, r) {
          ...
          (this.$config = a.mixin(i, { scroll: "x" })),
            (s._scrollHorizontalHandler = a.bind(
              s._scrollHorizontalHandler,
              s
            )),
            (s._scrollVerticalHandler = a.bind(s._scrollVerticalHandler, s)),
            (s._outerScrollVerticalHandler = a.bind(
              s._outerScrollVerticalHandler,
              s
            )),
            (s._outerScrollHorizontalHandler = a.bind(
              s._outerScrollHorizontalHandler,
              s
            )),
            (s._mouseWheelHandler = a.bind(s._mouseWheelHandler, s)),
            (this.$config.hidden = !0);
          var o = r.config.scroll_size;
          return (
            r.env.isIE && (o += 1),
            this._isHorizontal()
              ? ((s.$config.height = o), (s.$parent.$config.height = o))
              : ((s.$config.width = o), (s.$parent.$config.width = o)),
        ...
        function i(t, e) {
          if ((e.push(t), t.$cells))
            for (var n = 0; n < t.$cells.length; n++) i(t.$cells[n], e);
        }
        return (
          n(e, t),
          ...
          (e.prototype._getLinkedViews = function() {
            for (var t = this._eachView(), e = [], i = 0; i < t.length; i++)
              t[i].$config &&
                ((this._isVertical() && t[i].$config.scrollY == this.$id) ||
                  (this._isHorizontal() && t[i].$config.scrollX == this.$id)) &&
                e.push(t[i]);
            return e;
          }),
          ...
          (e.prototype.scrollHorizontally = function(t) {
            if (!this._scrolling) {
              ...
              (this.$config.scrollPosition = t),
                this.callEvent("onScroll", [n, t, this.$config.scroll]),
                (this._scrolling = !1);
            }
          }),
          ...
          (e.prototype._getScrollSize = function() {
            for (
              var t,
                ...
                a = n ? "scrollWidth" : "scrollHeight",
                s = n ? "contentX" : "contentY",
                o = n ? "x" : "y",
                l = this._getScrollOffset(),
                d = 0;
              d < r.length;
              d++
            )
          ...
          (e.prototype.setSize = function(e, i) {
            ...
            var n = this._getScrollSize(),
              r =
                (this._isVertical() ? i : e) -
                this._getScrollOffset() +
                (this._isHorizontal() ? 1 : 0);
            n.innerScroll &&
              r > n.outerScroll &&
              (n.innerScroll += r - n.outerScroll),
              (this.$config.scrollSize = n.innerScroll),
              (this.$config.width = e),
              (this.$config.height = i),
              this._setScrollSize(n.innerScroll);
          }),
          ...
          (e.prototype._getScaleOffset = function(t) {
            ...
            return (
              !t ||
                ("timeline" != t.$config.view && "grid" != t.$config.view) ||
          ...
          (e.prototype._getScrollOffset = function() {
            ...
            if (this._isVertical()) {
              ...
              t = Math.max(
                this._getScaleOffset(e.getPrevSibling(this.$parent.$id)),
                this._getScaleOffset(e.getNextSibling(this.$parent.$id))
              );
            } else
          ...
          (e.prototype._setScrollSize = function(t) {
            ...
            n
              ? this._isVertical()
                ? ((this.$config.outerSize = this.$config.height - n + 3),
                  (i.style.height = this.$config.outerSize + "px"),
                  (i.style.top = n - 1 + "px"),
                  r.addClassName(i, this.$parent._borders.top),
                  r.addClassName(i.parentNode, "gantt_task_vscroll"))
                : ((this.$config.outerSize = this.$config.width - n + 1),
                  (i.style.width = this.$config.outerSize + "px"))
              : ((i.style.top = "auto"),
                r.removeClassName(i, this.$parent._borders.top),
                r.removeClassName(i.parentNode, "gantt_task_vscroll"),
          ...
          (e.prototype._checkWheelTarget = function(t) {
            for (
              var e = this._getLinkedViews().concat(this), i = 0;
              i < e.length;
              i++
            ) {
              var n = e[i].$view;
            ...
            if (this._checkWheelTarget(e)) {
              ...
              if (
                ...
                var o = r / -40,
                  ...
                  d = l + 30 * o;
                if (
                  (this.scrollHorizontally(d),
                  (this.$scroll_hor.scrollLeft = d),
                ...
                if (
                  (this.scrollVertically(h),
                  (this.$scroll_ver.scrollTop = h),
    ...
    function n(t) {
      ...
      return {
        ...
        setSumWidth: function(t, e, i, n) {
          ...
          if (!(i > r.length - 1 || a <= 0 || n > r.length - 1)) {
            var s = this.getSum(r, i, n),
              o = t - s;
            this.adjustSize(o, r, i, n),
              this.adjustSize(-o, r, n + 1),
        ...
        adjustSize: function(t, e, i, n) {
          ...
          for (
            var r = n - i + 1, a = this.getSum(e, i, n), s = 0, o = i;
            o <= n;
            o++
          ) {
        ...
        sortScales: function(t) {
          ...
          t.sort(function(t, e) {
            return i(t.unit, t.step) < i(e.unit, e.step)
              ? 1
              : i(t.unit, t.step) > i(e.unit, e.step)
                ? -1
                : 0;
          });
        ...
        prepareConfigs: function(t, e, i, n, r, a, s) {
          for (
            var o = this.splitSize(n, t.length),
              l = i,
              d = [],
              c = t.length - 1;
            c >= 0;
            ...
            h && this.processIgnores(u),
              this.initColSizes(u, e, l, o[c]),
              this.limitVisibleRange(u),
              h && (l = u.full_width),
              d.unshift(u);
          }
        ...
        reverseScale: function(t) {
          ...
          for (var i = 0; i < t.trace_x.length; i++)
            (t.trace_indexes[t.trace_x[i].valueOf()] = i),
              (t.trace_index_transition[e[t.trace_x[i].valueOf()]] = i);
          return t;
        },
        ...
        _ignore_time_config: function(t, n) {
          if (i.config().skip_off_time) {
            for (var r = !0, a = t, s = 0; s < n.step; s++)
              s && (a = e.add(t, s, n.unit)),
                (r = r && !this.isWorkTime(a, n.unit));
            return r;
          }
          return !1;
        },
        ...
        initColSizes: function(t, i, n, r) {
          ...
          s || (s = 1),
            (t.col_width = Math.floor(a / s)),
            i && t.col_width < i && ((t.col_width = i), (a = t.col_width * s)),
            (t.width = []);
          for (var o = t.ignore_x || {}, l = 0; l < t.trace_x.length; l++)
            if (o[t.trace_x[l].valueOf()] || t.display_count == t.count)
              ...
              if ("month" == t.unit) {
                var c = Math.round(
                  (e.add(t.trace_x[l], t.step, t.unit) - t.trace_x[l]) / 864e5
                );
                d = c;
              }
              t.width[l] = d;
        ...
        initScaleConfig: function(t, e, i) {
          ...
          return (
            this.eachColumn(t.unit, t.step, e, i, function(t) {
              n.count++,
                n.trace_x.push(new Date(t)),
                (n.trace_indexes[t.valueOf()] = n.trace_x.length - 1);
            }),
            (n.trace_x_ascending = n.trace_x.slice()),
            n
          );
        },
        ...
        eachColumn: function(i, n, r, a, s) {
          ...
          for (+d >= +l && (l = e.add(d, n, i)); +d < +l; ) {
            ...
            (d = e.add(d, n, i)),
              (d = t._correct_dst_change(d, c, n, i)),
              e[i + "_start"] && (d = e[i + "_start"](d));
          }
        },
        limitVisibleRange: function(t) {
          ...
          if (+i[0] < +t.min_date && 0 != n) {
            var a = Math.floor(
              t.width[0] * ((i[1] - t.min_date) / (i[1] - i[0]))
            );
            (r += t.width[0] - a),
              (t.width[0] = a),
              (i[0] = new Date(t.min_date));
          }
          var s = i.length - 1,
            o = i[s],
          ...
          if (+l > +t.max_date && s > 0) {
            var a =
              t.width[s] -
              Math.floor(t.width[s] * ((l - t.max_date) / (l - o)));
            (r += t.width[s] - a), (t.width[s] = a);
          }
          if (r) {
            for (
              var d = this.getSum(t.width), c = 0, h = 0;
              h < t.width.length;
              h++
            ) {
  ...
  function(t, e, i) {
    var n = i(0),
      ...
      a = function(t, e) {
        ...
        function r(t) {
          var e = /^rgba?\(([\d]{1,3}), *([\d]{1,3}), *([\d]{1,3}) *(,( *[\d\.]+ *))?\)$/i.exec(
            t
          );
          return e
            ? { r: 1 * e[1], g: 1 * e[2], b: 1 * e[3], a: 255 * e[5] || 255 }
            : null;
        }
        function a(t) {
          return g[t] || null;
        ...
        function d(t, e, i) {
          ...
          return (
            (function(t, e, i, a, s, o) {
              ...
              for (
                var d = 1 * o.rightBorderWidth,
                  c = r(o.rightBorderColor),
                  h = 0,
                  u = 0,
                  _ = 0,
                  g = 1;
        ...
        function u(t, i, n, r) {
          ...
          if (e.isIE) {
            ...
            (-1 == u.indexOf("Windows NT 6.2") &&
              -1 == u.indexOf("Windows NT 6.1") &&
              -1 == u.indexOf("Windows NT 6.0")) ||
              (h = 2e4);
          }
          for (var _ = 0; _ < d.length; _++) {
            ...
            if ((g != s && void 0 !== s) || _ == d.length - 1 || l > h) {
              for (
                var f = r,
                  p = 0,
                  v = Math.floor(h / i.row_height) * i.row_height,
                  m = l;
                f > 0;
                ...
                (f -= v),
                  ...
                  (a.style.top = p + "px"),
                  (a.style.left = c + "px"),
                  (a.style.whiteSpace = "no-wrap"),
                  (a.className = t[s || g]),
                  _ == d.length - 1 && (m = g + m - 1),
                  (a.style.width = m + "px"),
                  o.push(a),
                  (p += k);
              }
      ...
      var i = function() {
          for (
            ...
            if (((r += d.width), (l = n.rtl ? a - r : r), d.resize)) {
              ...
              (c.className = "gantt_grid_column_resize_wrap"),
                (c.style.top = "0px"),
                (c.style.height = s + "px"),
                (c.innerHTML = "<div class='gantt_grid_column_resize'></div>"),
                c.setAttribute(n.grid_resizer_column_attribute, o),
                t._waiAria.gridSeparatorAttr(c),
                e.$grid_scale.appendChild(c),
                (c.style.left = Math.max(0, l) + "px");
            }
          }
        },
        n = {
          ...
          column_after_start: t.bind(function(t, i, n) {
            ...
            (t.config.marker.innerHTML = ""),
              ...
              (t.config.marker.style.height = e.$grid.offsetHeight + "px"),
              (t.config.marker.style.top = "0px"),
              (t.config.drag_index = a);
          }, t),
          column_drag_move: t.bind(function(t, i, n) {
            ...
            for (var p = 0; p < l; p++) (u += o[p].width), (g += o[p].width);
            if ((h < u && (h = u), a.keep_grid_width)) {
              for (var v = 0, p = l + 1; p < o.length; p++)
                o[p].min_width
                  ? (_ -= o[p].min_width)
                  : a.min_grid_column_width && (_ -= a.min_grid_column_width),
                  o[p].max_width && !1 !== v ? (v += o[p].max_width) : (v = !1);
              v && (u = e.$grid_data.offsetWidth - v),
                h < u && (h = u),
                h > _ && (h = _);
            }
            return (
              (s.left = h - 1),
              (f = Math.abs(h - g)),
              d.max_width && f > d.max_width && (f = d.max_width),
              a.rtl && (g = c.width - g + 2 - f),
              (s.marker.style.top = c.y + "px"),
              (s.marker.style.left = c.x - 1 + g + "px"),
              (s.marker.style.width = f + "px"),
              e.callEvent("onColumnResize", [l, o[l], f - 1]),
              !0
            );
          }, t),
          column_drag_end: t.bind(function(i, n, r) {
            for (
              var a = e.$getConfig(),
                s = e.getGridColumns(),
                o = 0,
                l = parseInt(i.config.drag_index, 10),
                d = s[l],
                c = 0;
              c < l;
              c++
              ...
              o += s[c].width;
            var h =
              d.min_width && i.config.left - o < d.min_width
                ? d.min_width
                : i.config.left - o;
            if (
              (d.max_width && d.max_width < h && (h = d.max_width),
              !1 !== e.callEvent("onColumnResizeEnd", [l, d, h]) &&
                d.width != h)
            ) {
              if (((d.width = h), a.keep_grid_width)) o = a.grid_width;
              else for (var c = l, u = s.length; c < u; c++) o += s[c].width;
              e.callEvent("onColumnResizeComplete", [
                s,
                e._setColumnsWidth(o, l)
              ]),
                e.$config.scrollable ||
                  t.$layout._syncCellSizes(e.$config.group, a.grid_width),
                this.render();
            }
          }, t)
        };
      return {
        init: function() {
          var i = t.$services.getService("dnd"),
            r = e.$getConfig(),
            a = new i(e.$grid_scale, { updates_per_second: 60 });
          t.defined(r.dnd_sensitivity) &&
            (a.config.sensitivity = r.dnd_sensitivity),
            a.attachEvent("onBeforeDragStart", function(t, e) {
                ...
                t.prototype._initEvents.apply(this, arguments),
                  this._mouseDelegates.delegate(
                    ...
                    gantt.bind(function(t, e, i) {
                      ...
                      return (
                        a &&
                          r.select(a.getAttribute(this.$config.item_attribute)),
                        !1
                      );
                    }, this),
                    this.$grid
    ...
    function i(t) {
      ...
      function i(e, i) {
        if (!t._isAllowedUnscheduledTask(e)) {
          ...
          _ == s.types.milestone && s.link_line_width > 1 && (g += 1),
            _ == s.types.milestone &&
              ((n.left -= Math.round(u / 2)), (n.width = u));
          var f = document.createElement("div"),
            p = Math.round(n.width);
          i.$config.item_attribute &&
            f.setAttribute(i.$config.item_attribute, e.id),
            s.show_progress && _ != s.types.milestone && l(e, f, p, s, d);
          var v = o(e, p, d);
          e.textColor && (v.style.color = e.textColor), f.appendChild(v);
          var m = c(
            "gantt_task_line",
            d.task_class(e.start_date, e.end_date, e),
            e.id,
            i
          );
          (e.color || e.progressColor || e.textColor) &&
            (m += " gantt_task_inline_color"),
            (f.className = m);
          var k = [
            "left:" + n.left + "px",
            "top:" + (g + n.top) + "px",
            "height:" + u + "px",
            "line-height:" + Math.max(u < 30 ? u - 2 : u, 0) + "px",
            "width:" + p + "px"
          ];
          e.color && k.push("background-color:" + e.color),
            e.textColor && k.push("color:" + e.textColor),
            (f.style.cssText = k.join(";"));
          var y = r(e, s, d);
          y && f.appendChild(y),
            (y = a(e, s, d)),
            y && f.appendChild(y),
            t._waiAria.setTaskBarAttr(e, f);
          var b = t.getState();
          return (
            t.isReadonly(e) ||
              (s.drag_resize &&
              ...
              s.drag_links &&
                ...
                h(
                  ...
                  function(t) {
                    ...
                    var n = !1;
                    return (
                      b.link_source_id && s.touch && (n = !0),
                      (i.style.display = n ? "block" : ""),
                      e.appendChild(i),
                      e
                    );
                  },
      ...
      function o(e, i, n) {
        ...
        return (
          t.getTaskType(e.type) != t.config.types.milestone &&
            (r.innerHTML = n.task_text(e.start_date, e.end_date, e)),
      ...
      function l(e, i, n, r, a) {
        ...
        (l = Math.min(n, l)),
          e.progressColor &&
            ((o.style.backgroundColor = e.progressColor),
            (o.style.opacity = 1)),
          (o.style.width = l + "px"),
          (o.className = "gantt_task_progress"),
          (o.innerHTML = a.progress_text(e.start_date, e.end_date, e)),
          r.rtl && ((o.style.position = "absolute"), (o.style.right = "0px"));
        var d = document.createElement("div");
        if (
          ((d.className = "gantt_task_progress_wrapper"),
          d.appendChild(o),
          i.appendChild(d),
          ...
          r.rtl && (h = n - l),
            (c.style.left = h + "px"),
            (c.className = "gantt_task_progress_drag"),
            o.appendChild(c),
            i.appendChild(c);
        }
      }
      ...
      function c(e, i, n, r) {
        ...
        if (
          (t.getTaskType(l.type) == a.types.milestone &&
            s.push("gantt_milestone"),
          t.getTaskType(l.type) == a.types.project && s.push("gantt_project"),
          t.isSummaryTask(l) && s.push("gantt_dependent_task"),
          a.select_task && n == o.selected_task && s.push("gantt_selected"),
          n == o.drag_id &&
            (s.push("gantt_drag_" + o.drag_mode),
            o.touch_drag && s.push("gantt_touch_" + o.drag_mode)),
          o.link_source_id == n && s.push("gantt_link_source"),
          o.link_target_id == n && s.push("gantt_link_target"),
          a.highlight_critical_path &&
            t.isCriticalTask &&
            t.isCriticalTask(l) &&
            s.push("gantt_critical_task"),
          o.link_landing_area &&
            o.link_target_id &&
            o.link_source_id &&
            o.link_target_id != o.link_source_id)
        ) {
      ...
      function h(e, i, n, r, a) {
        var s,
          o,
          l = t.getState();
        +n.start_date >= +l.min_date &&
          ((s = [i, a.rtl ? "task_right" : "task_left", "task_start_date"]),
          (o = r(s.join(" "))),
          o.setAttribute("data-bind-property", "start_date"),
          e.appendChild(o)),
          +n.end_date <= +l.max_date &&
            ((s = [i, a.rtl ? "task_left" : "task_right", "task_end_date"]),
            (o = r(s.join(" "))),
            o.setAttribute("data-bind-property", "end_date"),
            e.appendChild(o));
      }
      return e;
    }
  ...
  function(t, e) {
    function i(t) {
      function e(e, i) {
        ...
        if (n.show_task_cells)
          for (var l = 0; l < s; l++) {
            ...
            if (d > 0) {
              ...
              (h.style.width = d + "px"),
                (c =
                  "gantt_task_cell" + (l == s - 1 ? " gantt_last_cell" : "")),
                (_ = r.task_cell_class(e, a.trace_x[l])),
                _ && (c += " " + _),
                (h.className = c),
                o.appendChild(h);
            }
        ...
        return (
          i.$config.rowStore.getSelectedId() == e.id &&
            (g += " gantt_selected"),
          (o.className = g),
          n.smart_rendering &&
            ((o.style.position = "absolute"),
            (o.style.top = i.getItemTop(e.id) + "px"),
            (o.style.width = "100%")),
          (o.style.height = n.row_height + "px"),
          i.$config.item_attribute &&
            o.setAttribute(i.$config.item_attribute, e.id),
          o
        );
      }
      return e;
      ...
      function e(e, n) {
        ...
        h && (c += " " + h),
          s.highlight_critical_path &&
            t.isCriticalLink &&
            t.isCriticalLink(e) &&
            (c += " gantt_critical_link"),
          (d.className = c),
          n.$config.link_attribute &&
            d.setAttribute(n.$config.link_attribute, e.id);
        for (var u = 0; u < l.length; u++) {
          u == l.length - 1 && (l[u].size -= s.link_arrow_size);
          var _ = r.render_line(l[u], l[u + 1], n);
          e.color && (_.firstChild.style.backgroundColor = e.color),
            d.appendChild(_);
        }
        var g = l[l.length - 1].direction,
          f = i(o[o.length - 1], g, n);
        return (
          e.color && (f.style.borderColor = e.color),
          d.appendChild(f),
          t._waiAria.linkAttr(e, d),
          d
        );
      }
      function i(t, e, i) {
        ...
        return (
          (a.style.cssText = ["top:" + s + "px", "left:" + o + "px"].join(";")),
          (a.className = c),
          a
        );
      }
      ...
      var r = {
          ...
          render_line: function(t, e, i) {
            ...
            return (
              (s.style.cssText = [
                "height:" + a.height + "px",
                "width:" + a.width + "px",
                "margin-top:" + a.marginTop + "px",
                "margin-left:" + a.marginLeft + "px"
              ].join(";")),
          ...
          _get_line: function(t, e) {
            var i = this.get_direction(t, e),
              n = { x: t.x, y: t.y, direction: this.get_direction(t, e) };
            return (
              i == this.dirs.left || i == this.dirs.right
                ? (n.size = Math.abs(t.x - e.x))
                : (n.size = Math.abs(t.y - e.y)),
              n
            );
          },
        ...
        a = {
          ...
          point_to: function(e, i, n) {
            n = n ? { x: n.x, y: n.y } : t.copy(this.point());
            var a = r.dirs;
            switch (e) {
              case a.left:
                n.x -= i;
          ...
          get_points: function(e, i) {
            var n = this.get_endpoint(e, i),
              ...
              o = n.e_x - n.x,
              l = r.dirs;
            this.clear(), this.point({ x: n.x, y: n.y });
            var d = 2 * a.link_arrow_size,
              c = this.get_line_type(e, i.$getConfig()),
              h = n.e_x > n.x;
            if (c.from_start && c.to_start)
              this.point_to(l.left, d),
                h
                  ? (this.point_to(l.down, s), this.point_to(l.right, o))
                  : (this.point_to(l.right, o), this.point_to(l.down, s)),
                this.point_to(l.right, d);
              ...
              if (((h = n.e_x > n.x + 2 * d), this.point_to(l.right, d), h))
                ...
                o -= 2 * d;
                var u = s > 0 ? 1 : -1;
                this.point_to(l.down, u * (a.row_height / 2)),
                  this.point_to(l.right, o),
                  this.point_to(l.down, u * (Math.abs(s) - a.row_height / 2)),
                  this.point_to(l.right, d);
              }
            else if (c.from_start || c.to_start) {
              if (c.from_start && !c.to_start)
          ...
          get_line_type: function(e, i) {
            ...
            return (
              e.type == n.start_to_start
                ? (r = a = !0)
                : e.type == n.finish_to_finish
                  ? (r = a = !1)
                  : e.type == n.finish_to_start
                    ? ((r = !1), (a = !0))
                    : e.type == n.start_to_finish
                      ? ((r = !0), (a = !1))
                      : t.assert(!1, "Invalid link type"),
              i.rtl && ((r = !r), (a = !a)),
              { from_start: r, to_start: a }
            );
          },
      ...
      function e(e, i) {
        ...
        for (var l, d = [], c = 0; c < n.length; c++) {
          ...
          if ("add" == f.name) {
            ...
            (u = f.template ? f.template(e) : e[f.name]),
              r.isDate(u) && (u = s.date_grid(u, e)),
              (_ = u),
              (u = "<div class='gantt_tree_content'>" + u + "</div>");
          var v = "gantt_cell" + (g ? " gantt_last_cell" : ""),
            m = [];
          if (f.tree) {
            for (var k = 0; k < e.$level; k++) m.push(s.grid_indent(e));
            (l = o.hasChild(e.id)),
              l
                ? (m.push(s.grid_open(e)), m.push(s.grid_folder(e)))
                : (m.push(s.grid_blank(e)), m.push(s.grid_file(e)));
          }
        ...
        if (
          ((v += e.$transparent ? " gantt_transparent" : ""),
          (v += e.$dataprocessor_class ? " " + e.$dataprocessor_class : ""),
          s.grid_row_class)
        ) {
        ...
        return (
          ($.style.height = w + "px"),
          ($.style.lineHeight = w + "px"),
          a.smart_rendering &&
            (($.style.position = "absolute"),
            ($.style.left = "0px"),
            ($.style.top = i.getItemTop(e.id) + "px")),
          i.$config.item_attribute &&
            $.setAttribute(i.$config.item_attribute, e.id),
          t._waiAria.taskRowAttr(e, $),
          ($.innerHTML = d.join("")),
          $
        );
      }
        ...
        return function(t) {
          return {
            onCreated: function(e) {
              (e.$config = n.mixin(e.$config, { bind: "task" })),
                "grid" == e.$config.id && this.extendGantt(e),
                (this._mouseDelegates = i(9)(t));
            },
            onInitialized: function(e) {
              e.$getConfig().order_branch && r.init(e.$gantt, e),
                this.initEvents(e, t),
            ...
            initEvents: function(t, e) {
              this._mouseDelegates.delegate(
                "click",
                "gantt_row",
                e.bind(function(i, n, r) {
                  var a = t.$getConfig();
                  if (null !== n) {
                    var s = this.getTask(n);
                    a.scroll_on_click &&
                      !e._is_icon_open_click(i) &&
                      this.showDate(s.start_date),
                      e.callEvent("onTaskRowClick", [n, r]);
                  }
                }, e),
                t.$grid
              ),
                ...
                this._mouseDelegates.delegate(
                  ...
                  "gantt_add",
                  e.bind(function(i, n, r) {
                    if (!t.$getConfig().readonly&&t.$getConfig().can_add) {
                      var a = {};
  ...
  function(t, e, i) {
    function n(t, e) {
      ...
      if (e.$config.bind && t.getDatastore(e.$config.bind)) {
        var s = new a(e.$grid_data, { updates_per_second: 60 });
        t.defined(e.$getConfig().dnd_sensitivity) &&
          ...
          s.attachEvent(
            ...
            t.bind(function(r, a) {
              ...
              return (
                !t.isReadonly(c) &&
                ((s.config.initial_open_state = c.$open),
          ...
          s.attachEvent(
            ...
            t.bind(function(t, r) {
              ...
              o && (o.style.position = "static"),
                (s.config.id = a.getAttribute(e.$config.item_attribute));
              var l = n(),
                d = l.getItem(s.config.id);
              (s.config.index = l.getBranchIndex(s.config.id)),
                (s.config.parent = d.parent),
                (d.$open = !1),
                (d.$transparent = !0),
                this.refreshData();
            }, t)
          ),
          (s.lastTaskOfLevel = function(t) {
            for (
              var e = null, i = n(), r = i.getItems(), a = 0, s = r.length;
              a < s;
              a++
            )
              r[a].$level == t && (e = r[a]);
          ...
          (s._getGridPos = t.bind(function(t) {
            ...
            return (
              o > i.y + d - l.row_height && (o = i.y + d - l.row_height),
              (i.x = s),
              (i.y = o),
              i
            );
          }, t)),
          (s._getTargetY = t.bind(function(t) {
            var i = r.getNodePosition(e.$grid_data),
              n = t.pageY - i.y + (e.$state.scrollTop || 0);
            return n < 0 && (n = 0), n;
          }, t)),
          (s._getTaskByY = t.bind(function(t, i) {
            var r = e.$getConfig(),
              a = n();
            t = t || 0;
            ...
            return (
              (s = i < s ? s - 1 : s),
              s > a.countVisible() - 1 ? null : a.getIdByIndex(s)
            );
          }, t)),
          s.attachEvent(
            "onDragMove",
            t.bind(function(t, i) {
              function r(t, e) {
                return (
                  !d.isChildOf(_.id, e.id) &&
                  ((t.$level == e.$level&&t.parent==e.parent) || l.order_branch_free)
                );
              }
              var a = s.config,
                o = s._getGridPos(i),
                l = e.$getConfig(),
                d = n();
              (a.marker.style.left = o.x + 10 + "px"),
                (a.marker.style.top = o.y + "px");
              ...
              if (
                ...
                var _ = d.getItem(u);
                if (
                  d.getIndexById(_.id) * l.row_height + l.row_height / 2 <
                  h
                ) {
                  ...
                  if (p) {
                    if (p.id == c.id)
                      return l.order_branch_free &&
                        d.isChildOf(c.id, _.id) &&
                        1 == d.getChildren(_.id).length
                        ? void d.move(
                            c.id,
                            d.getBranchIndex(_.id) + 1,
                            d.getParent(_.id)
                          )
                        : void 0;
                    _ = p;
                ...
                } else if (l.order_branch_free && _.id != c.id && r(_, c)) {
                  if (!d.hasChild(_.id))
                    return (_.$open = !0), void d.move(c.id, -1, _.id);
                  if (d.getIndexById(_.id) || l.row_height / 3 < h) return;
                }
                for (
                  var g = d.getIndexById(_.id),
                    v = d.getIdByIndex(g - 1),
                    m = d.getItem(v),
                    k = 1;
                  (!m || m.id == _.id) && g - k >= 0;
                ...
                if (c.id == _.id) return;
                r(_, c) && c.id != _.id
                  ? d.move(c.id, 0, 0, _.id)
                  : _.$level != c.$level - 1 || d.getChildren(_.id).length
                    ? m &&
                      r(m, c) &&
                      c.id != m.id &&
                      d.move(c.id, -1, d.getParent(m.id))
                    : d.move(c.id, 0, _.id);
              }
              return !0;
            }, t)
          ...
          s.attachEvent(
            ...
            t.bind(function() {
              ...
              (e.$transparent = !1),
                (e.$open = s.config.initial_open_state),
                !1 ===
                this.callEvent("onBeforeRowDragEnd", [
                  ...
                  ? (t.move(s.config.id, s.config.index, s.config.parent),
                    (e.$drop_target = null))
      ...
      o = (function() {
        return function(t) {
          ...
          return {
            onCreated: function(e) {
              var s = e.$config;
              (s.bind = n.defined(s.bind) ? s.bind : "task"),
                (s.bindLinks = n.defined(s.bindLinks) ? s.bindLinks : "link"),
              ...
              this._mouseDelegates.delegate(
                ...
                this._mouseDelegates.delegate(
                  ...
                  t.bind(function(t, i, n) {
                    ...
                    return (
                      n.parentNode &&
                        s.getClassName(n.parentNode) &&
                        (a =
                          s.getClassName(n.parentNode).indexOf("_left") > -1
                            ? r.$target[0]
                            : r.$source[0]),
                      a && e.call(this, a, t),
                      !1
            ...
            _attachStateProvider: function(t, i) {
              ...
              e
                .getService("state")
                .registerProvider("tasksTimeline", function() {
                  return {
    ...
    function n(t, e) {
      ...
      return {
        ...
        init: function() {
          ...
          this.set_actions(),
            i.getService("state").registerProvider(
              "tasksDnd",
              s.bind(function() {
                return {
          ...
          for (var r in this._events)
            for (var a in t) this._events[r][a] = n[r];
        ...
        _resize: function(i, n, r) {
          ...
          r.left
            ? ((i.start_date = e.dateFromPos(s.start + n)),
              i.start_date || (i.start_date = new Date(e.getState().min_date)))
            : ((i.end_date = e.dateFromPos(s.end + n)),
              i.end_date || (i.end_date = new Date(e.getState().max_date))),
            i.end_date - i.start_date < a.min_duration &&
              (r.left
                ? (i.start_date = e.calculateEndDate({
        ...
        _move: function(t, i, n) {
          ...
          a
            ? s
              ? ((t.start_date = a), (t.end_date = s))
              : ((t.end_date = new Date(e.getState().max_date)),
                (t.start_date = e.dateFromPos(
                  e.posFromDate(t.end_date) - (r.end - r.start)
                )))
            : ((t.start_date = new Date(e.getState().min_date)),
              (t.end_date = e.dateFromPos(
                e.posFromDate(t.start_date) + (r.end - r.start)
              )));
        },
        ...
        on_mouse_move: function(t) {
          if (this.drag.start_drag) {
            ...
            (Date.now() - this.drag.timestamp > 50 ||
              (this._is_number(n) &&
                this._is_number(r) &&
                this._mouse_position_change({ x: n, y: r }, i) > 20)) &&
              this._start_dnd(t);
          }
          if (this.drag.mode) {
            if (!o(this, 40)) return;
        ...
        _update_item_on_move: function(t, i, n, r, a) {
          var s = e.getTask(i),
            o = e.mixin({}, s),
            l = e.mixin({}, s);
          this._handlers[n].apply(this, [l, t, r]),
            e.mixin(s, l, !0),
            e.callEvent("onTaskDrag", [s.id, n, l, o, a]),
            e.mixin(s, l, !0),
            e.refreshTask(i);
        },
        _update_on_move: function(i) {
          ...
          if (n.mode) {
            ...
            if (this._handlers[n.mode]) {
              ...
              } else this._update_item_on_move(d, n.id, n.mode, n, i);
        ...
        on_mouse_down: function(i, n) {
          if (2 != i.button || void 0 === i.button) {
            var r = t.$getConfig(),
              ...
              o = null;
            if (
              (e.isTaskExists(s) && (o = e.getTask(s)),
              !e.isReadonly(o) && !this.drag.mode)
            ) {
              ...
              if (!l || !d)
                return n.parentNode
                  ? this.on_mouse_down(i, n.parentNode)
                  : void 0;
              if (d)
                if (
                  d.mode &&
                  d.mode != r.drag_mode.ignore &&
                  r["drag_" + d.mode]
                ) {
                  if (
                    ((s = e.locate(n)),
                    (o = e.copy(e.getTask(s) || {})),
                    e.isReadonly(o))
                  )
                  ...
                  (d.start_x = c.x),
                    (d.start_y = c.y),
                    (d.obj = o),
                    (this.drag.start_drag = d),
                    (this.drag.timestamp = Date.now());
                } else this.clear_drag_state();
              else if (
                e.checkEvent("onMouseDown") &&
                e.callEvent("onMouseDown", [l.split(" ")[0]]) &&
                n.parentNode
              )
        ...
        _fix_dnd_scale_time: function(i, n) {
          function r(i) {
            if (e.config.correct_work_time) {
              var n = t.$getConfig();
              e.isWorkTime(i.start_date, void 0, i) ||
                (i.start_date = e.calculateEndDate({
                  start_date: i.start_date,
                  duration: -1,
          ...
          var a = t.$getConfig(),
            s = e.getScale().unit,
            o = e.getScale().step;
          a.round_dnd_dates || ((s = "minute"), (o = a.time_step)),
            n.mode == a.drag_mode.resize
              ? n.left
                ? ((i.start_date = e.roundDate({
                    date: i.start_date,
                    unit: s,
                    step: o
                  })),
                  r(i))
                : ((i.end_date = e.roundDate({
                    date: i.end_date,
                    unit: s,
                    step: o
                  })),
                  (function(i) {
                    if (e.config.correct_work_time) {
                      var n = t.$getConfig();
                      e.isWorkTime(new Date(i.end_date - 1), void 0, i) ||
                        (i.end_date = e.calculateEndDate({
                          start_date: i.end_date,
                          duration: 1,
                          unit: n.duration_unit,
              ...
              : n.mode == a.drag_mode.move &&
                ...
                r(i),
                (i.end_date = e.calculateEndDate(i)));
        },
        _fix_working_times: function(i, n) {
          var r = t.$getConfig(),
            n = n || { mode: r.drag_mode.move };
          n.mode == r.drag_mode.resize
            ? n.left
              ? (i.start_date = e.getClosestWorkTime({
                  date: i.start_date,
                  dir: "future",
                  task: i
                }))
        ...
        _finalize_mouse_up: function(t, i, n, r) {
          ...
          if (
            (i.work_time &&
              i.correct_work_time &&
              this._fix_working_times(a, n),
            this._fix_dnd_scale_time(a, n),
            this._fireEvent("before_finish", n.mode, [
              t,
              n.mode,
              e.copy(n.obj),
              r
            ...
            e._init_task_timing(a),
              ...
              e.updateTask(a.id),
              this._fireEvent("after_finish", n.mode, [s, n.mode, r]);
          } else
            this.clear_drag_state(),
              t == n.id && ((n.obj._dhx_changed = !1), e.mixin(a, n.obj, !0)),
              e.refreshTask(a.id);
        },
        ...
        _start_dnd: function(i) {
          ...
          if (
            r["drag_" + n.mode] &&
            e.callEvent("onBeforeDrag", [a, n.mode, i]) &&
            this._fireEvent("before_start", n.mode, [a, n.mode, i])
          ) {
            delete n.start_drag;
            var s = e.getTask(a);
            e.isSummaryTask(s) &&
        ...
        _fireEvent: function(t, i, n) {
          ...
          return (
            e.assert(r, "Unknown after drop mode:{" + i + "}"),
            e.assert(n, "Invalid event arguments"),
            !e.checkEvent(r) || e.callEvent(r, n)
          );
        },
    ...
    var n = i(1),
      r = function(t, e) {
        ...
        function s(t, i, n, a, s) {
          ...
          var c = r(t) && s ? 2 : 0;
          return (
            (n = n || 0), a.rtl && (n *= -1), (d.x += (i ? -1 : 1) * n - c), d
          );
        }
        function o(t, n, r) {
          var a = n(t),
            s = { x: a.left, y: a.top, width: a.width, height: a.height };
          if (
            (r.rtl
              ? ((s.xEnd = s.x), (s.x = s.xEnd + s.width))
              : (s.xEnd = s.x + s.width),
            (s.yEnd = s.y + s.height),
            e.getTaskType(t.type) == e.config.types.milestone)
          ) {
            var o = i();
            (s.x += (r.rtl ? 1 : -1) * (o / 2)),
              (s.xEnd += (r.rtl ? -1 : 1) * (o / 2)),
              (s.width = a.xEnd - a.x);
          }
          return s;
        }
        function l(t) {
          ...
          i.link_source_id &&
            ...
            (e.isLinkAllowed(
              ...
              ? n.push("gantt_allowed_link")
              : n.push("gantt_invalid_link"));
        ...
        function g() {
          return (
            x._direction ||
              ((x._direction = document.createElement("div")),
              t.$task_links.appendChild(x._direction)),
            x._direction
          );
        }
        function f() {
          x._direction &&
            (x._direction.parentNode &&
              x._direction.parentNode.removeChild(x._direction),
            (x._direction = null));
        }
        var p,
          v,
        ...
        var x = new w(t.$task_bars, { sensitivity: 0, updates_per_second: 60 });
        x.attachEvent(
          "onBeforeDragStart",
          e.bind(function(i, r) {
            var a = r.target || r.srcElement;
            if ((c(), e.getState().drag_id)) return !1;
            if (n.locateClassName(a, "gantt_link_point")) {
              n.locateClassName(a, "task_start_date") && (y = !0);
              var o = e.locate(r);
              k = o;
              var l = e.getTask(o);
              if (e.isReadonly(l)) return c(), !1;
          ...
          x.attachEvent(
            ...
            e.bind(function(i, r) {
              ...
              var c = !!n.locateClassName(r, "gantt_link_control"),
                ...
                k = !0;
              if (
                (c && ((k = !n.locateClassName(r, "task_end_date")), (c = !!f)),
                (v = f),
                (p = c),
                (m = k),
                c)
                ...
                var y = e.getTask(f),
                  ...
                  w = 0;
                $ && (w = Math.floor($.offsetWidth / 2)),
                  (this._dir_end = s(y, !!m, w, b));
              } else this._dir_end = n.getRelativeEventPosition(r, t.$task_data);
              var S = !(_ == c && u == f && g == k);
              return (
                S && (u && e.refreshTask(u, !1), f && e.refreshTask(f, !1)),
                S && l(a.marker),
                h(
                  this._dir_start.x,
                  this._dir_start.y,
          ...
          x.attachEvent(
            ...
            e.bind(function() {
              ...
              c(),
                e.config.touch
                  ? e.refreshData()
                  : (t.link_source_id && e.refreshTask(t.link_source_id, !1),
                    t.link_target_id && e.refreshTask(t.link_target_id, !1)),
                f();
            }, this)
          );
      };
        ...
        return function(t) {
          return {
            ...
            _legacyGridResizerClass: function(t) {
              for (
                var e = t.getCellsByType("resizer"), i = 0;
                i < e.length;
                i++
              ) {
                var n = e[i],
            ...
            onCreated: function(e) {
              ...
              this._legacyGridResizerClass(e),
                e.attachEvent("onBeforeResize", function() {
                  ...
                  r &&
                    (r.$config.hidden = r.$parent.$config.hidden = !t.config
                      .show_chart);
                  ...
                  if (a) {
                    ...
                    if (i) {
                      ...
                      !1 !== o && (t.config.grid_width = o),
                        (s = s && !!t.config.grid_width),
                        (t.config.show_grid = s);
                    }
                    if (
                      ...
                      if (
                        (l[0] &&
                          t.config.grid_width < l[0] &&
                          (t.config.grid_width = l[0]),
                        l[1] &&
                          t.config.grid_width > l[1] &&
                          (t.config.grid_width = l[1]),
                        ...
                        if (((a.$config.width = t.config.grid_width - 1), i))
                          ...
                          a.$parent._setContentSize(
                            a.$config.width,
                            a.$config.height
                          );
                      else
                        r &&
                          n.isChildOf(r.$task, e.$view) &&
                          (a.$config.original_grid_width = t.config.grid_width),
                          i || (a.$parent.$config.width = 0);
                    }
                    i = !1;
                  }
                }),
              ...
              r &&
                r.attachEvent("onScroll", function(e, i, n) {
                  var r = t.getScrollState();
                  t.callEvent("onGanttScroll", [r.x, e, r.x, i]);
                }),
                a &&
                  a.attachEvent("onScroll", function(e, i, n) {
                    var r = t.getScrollState();
                    t.callEvent("onGanttScroll", [e, r.y, i, r.y]);
                  }),
                e.attachEvent("onResize", function() {
                  r && !t.$scroll_ver && (t.$scroll_ver = r.$scroll_ver),
                    a && !t.$scroll_hor && (t.$scroll_hor = a.$scroll_hor);
                });
            },
            _findGridResizer: function(t, e) {
              for (
                var i, n = t.getCellsByType("resizer"), r = !0, a = 0;
                a < n.length;
                a++
              ) {
                var s = n[a];
              ...
              if (n.resizer) {
                ...
                s.attachEvent("onResizeStart", function(e, i) {
                  ...
                  if (s) {
                    ...
                    n.$config.scrollable || (s.$config.minWidth = o[0]),
                      (s.$config.maxWidth = o[1]);
                  }
      ...
      return {
        ...
        scrollTo: function(t, e) {
          var r = i(this),
            ...
            s = { position: 0 },
            o = { position: 0 };
          r && (o = r.getScrollState()),
            a && (s = a.getScrollState()),
            a && 1 * t == t && a.scroll(t),
            r && 1 * e == e && r.scroll(e);
          var l = { position: 0 },
            d = { position: 0 };
          r && (l = r.getScrollState()),
            a && (d = a.getScrollState()),
        ...
        showTask: function(t) {
          var e,
            i = this.getTaskPosition(this.getTask(t)),
            n = Math.max(i.left - this.config.task_scroll_offset, 0),
            r = this._scroll_state().y;
          (e = r ? i.top - (r - this.config.row_height) / 2 : i.top),
            this.scrollTo(n, e);
        },
        _scroll_state: function() {
          ...
          if (e) {
            ...
            s.visible && ((t.y = s.size), (t.y_inner = s.scrollSize)),
              (t.y_pos = s.position || 0);
          }
          return t;
        },
  ...
  function(t, e, i) {
    function n(t) {
      ...
      function o() {
        for (
          var i = null, n = t.$data.tasksStore.getItems(), r = 0, a = n.length;
          r < a;
          r++
        )
          (i = n[r]), (i.$source = []), (i.$target = []);
        for (
          var s = t.$data.linksStore.getItems(), r = 0, a = s.length;
          r < a;
          r++
        ) {
          e(s[r]);
      ...
      function d(e) {
        this.defined(e.id) || (e.id = this.uid()),
          e.start_date &&
            (e.start_date = t.date.parseDate(e.start_date, "xml_date")),
          e.end_date && (e.end_date = t.date.parseDate(e.end_date, "xml_date"));
        var i = null;
        return (
          (e.duration || 0 === e.duration) && (e.duration = i = 1 * e.duration),
          i &&
      ...
      var u = t.createDatastore({
        ...
        _ = t.createDatastore({ name: "link", initItem: r.bind(c, t) });
      u.attachEvent("onBeforeRefreshAll", function() {
        ...
        u.attachEvent("onFilterItem", function(e, i) {
          ...
          if (t.config.start_date && t.config.end_date) {
            ...
            if (
              ((n = t.config.start_date.valueOf()),
              (r = t.config.end_date.valueOf()),
              +i.start_date > r || +i.end_date < +n)
            )
              return !1;
          }
          return !0;
        ...
        u.attachEvent("onAfterItemMove", function(e, i, n) {
          ...
          null !== this.getNextSibling(e)
            ? (r.$drop_target = this.getNextSibling(e))
            : null !== this.getPrevSibling(e)
              ? (r.$drop_target = "next:" + this.getPrevSibling(e))
              : (r.$drop_target = "next:null");
        }),
        u.attachEvent("onStoreUpdated", function(e, i, n) {
          if (
            ("delete" == n && t._update_flags(e, null),
        ...
        _.attachEvent("onBeforeIdChange", function(i, r) {
          n(t.mixin({ id: i }, t.$data.linksStore.getItem(r))),
            e(t.$data.linksStore.getItem(r));
        }),
        _.attachEvent("onFilterItem", function(e, i) {
          return (
            !!t.config.show_links &&
            (!(
              !t.isTaskVisible(i.source) ||
              !t.isTaskVisible(i.target) ||
              t._isAllowedUnscheduledTask(t.getTask(i.source)) ||
              t._isAllowedUnscheduledTask(t.getTask(i.target))
            ) &&
              t.callEvent("onBeforeLinkDisplay", [e, i]))
          );
        }),
        (function() {
          var e = i(20),
        ...
        (t.$data = { tasksStore: u, linksStore: _ });
    }
    var r = i(0),
      a = i(64),
      s = i(19);
  ...
  function(t, e, i) {
    function n() {
      for (
        var t = this.$services.getService("datastores"), e = [], i = 0;
        i < t.length;
        i++
      )
      ...
      u = function() {
        return {
          ...
          refreshData: function() {
            ...
            for (var e = n.call(this), i = 0; i < e.length; i++) e[i].refresh();
          ...
          refreshTask: function(t, e) {
            ...
            if (i && this.isTaskVisible(t)) {
              if (
                (this.$data.tasksStore.refresh(t, !!this.getState().drag_id),
                void 0 !== e && !e)
              )
                return;
          ...
          selectTask: function(t) {
            ...
            return (
              !!this.config.select_task && (t && e.select(t), e.getSelectedId())
            );
          },
      ...
      r = function() {
        return {
          ...
          updateTask: function(t, e) {
            n.defined(e) || (e = this.getTask(t)),
              this.$data.tasksStore.updateItem(t, e),
              this.refreshTask(t);
          },
          addTask: function(t, e, i) {
            return (
              n.defined(t.id) || (t.id = n.uid()),
              n.defined(e) || (e = this.getParent(t) || 0),
              this.isTaskExists(e) || (e = 0),
              this.setParent(t, e),
              this.$data.tasksStore.addItem(t, i, e)
            );
          },
          ...
          changeTaskId: function(t, e) {
            ...
            var i = this.$data.tasksStore.getItem(e),
              n = [];
            i.$source && (n = n.concat(i.$source)),
              i.$target && (n = n.concat(i.$target));
      ...
      return {
        select: function(e) {
          if (e) {
            ...
            this.unselect(),
              (t = e),
              this._skip_refresh ||
                (this.refresh(e), this.callEvent("onAfterSelect", [e]));
          }
          return t;
        },
        getSelectedId: function() {
        ...
        unselect: function(e) {
          ...
          e &&
            ((t = null),
            this._skip_refresh ||
              (this.refresh(e), this.callEvent("onAfterUnselect", [e])));
        }
      };
    }
    t.exports = i;
  ...
  function(t, e) {
    var i = function(t, e) {
      function i(t) {
        return !!t.$services.getService("state").getState("batchUpdate")
          .batch_update;
      }
      function n(t, e, i, n) {
        ...
        a = {
          renderItem: function(t, e) {
            var i = e.getLayers(),
              n = r.getItem(t);
            if (n && r.isVisible(t))
              for (var a = 0; a < i.length; a++) i[a].render_item(n);
          },
      ...
      r.attachEvent("onStoreUpdated", function(n, s, o) {
        if (!i(e)) {
          ...
          l &&
            (r.filter(),
            n && "move" != o && "delete" != o
              ? (r.callEvent("onBeforeRefreshItem", [s.id]),
                a.renderItem(s.id, l),
                r.callEvent("onAfterRefreshItem", [s.id]))
              : (r.callEvent("onBeforeRefreshAll", []),
                a.renderItems(l),
                r.callEvent("onAfterRefreshAll", [])));
        }
      }),
        ...
        r.attachEvent("onIdChange", function(s, o) {
          if (
            ...
            r.callEvent("onBeforeIdChange", [s, o]),
            !i(e))
          ) {
            var l = e.$services.getService("layers").getDataRender(t);
    ...
    t.exports = { bindDataStore: i };
  },
  function(t, e, i) {
    function n(t) {
      function e(t, e) {
        delete e.$gantt,
          delete e.setGanttMode,
          delete e._getRowData,
          (e.afterUpdate = d),
          delete t._dp,
          delete t._change_id,
          delete t._row_style,
          delete t._delete_task,
          delete t._sendTaskOrder,
          s.forEach(c, function(e) {
            t.detachEvent(e);
          }),
          (c = []);
      }
      function n(t, e) {
        (e.setGanttMode = function(t) {
          ...
          var n = i[t];
          n || (n = i[t] = { _in_progress: {}, _invalid: {}, updatedRows: [] }),
          ...
          (e.afterUpdate = function() {
            ...
            (i =
              "REST" != this._tMode
                ? -1 != n.indexOf("gantt_mode=links")
                  ? "links"
                  : "tasks"
                : n.indexOf("/link") > n.indexOf("/task")
                  ? "links"
                  : "tasks"),
              e.setGanttMode(i);
          ...
          (e._getRowData = t.bind(function(i, n) {
            ...
            for (var o in r)
              if ("$" != o.substr(0, 1)) {
                var l = r[o];
                a.isDate(l)
                  ? (s[o] = this.templates.xml_format(l))
                  : (s[o] = null === l ? "" : l);
              }
            var d = this._get_task_timing_mode(r);
            return (
              d.$no_start && ((r.start_date = ""), (r.duration = "")),
              d.$no_end && ((r.end_date = ""), (r.duration = "")),
              (s[e.action_param] = this.getUserData(i, e.action_param)),
              s
            );
          }, t));
      }
      function o(t, e) {
        (t._change_id = t.bind(function(t, i) {
          "tasks" != e._ganttMode
            ? this.changeLinkId(t, i)
            : this.changeTaskId(t, i);
        }, this)),
          (t._row_style = function(i, n) {
          ...
          (t._sendTaskOrder = function(t, i) {
            i.$drop_target &&
              ...
              (this.getTask(t).target = i.$drop_target),
              e.setUpdated(t, !0, "order"),
      ...
      function l(t, e) {
        function n(i) {
          for (
            var n = e.updatedRows.slice(), r = !1, a = 0;
            a < n.length && !e._in_progress[i];
            a++
          )
            n[a] == i &&
              ("inserted" == t.getUserData(i, "!nativeeditor_status") &&
                (r = !0),
              e.setUpdated(i, !1));
          return r;
        }
        ...
        var a = i(20),
          s = {};
        c.push(
          this.attachEvent("onBeforeTaskDelete", function(e, i) {
            return (
              !t.config.cascade_delete ||
              ((s[e] = {
          ...
          c.push(
            this.attachEvent("onAfterTaskDelete", function(i, r) {
              if ((e.setGanttMode("tasks"), !n(i))) {
                if (t.config.cascade_delete && s[i]) {
                  ...
                  for (var l in o.links) n(l) || e.setUpdated(l, !0, "deleted");
                  (s[i] = null),
                    "off" != a && e.sendAllData(),
                    e.setGanttMode("tasks"),
                    e.setUpdateMode(a);
                }
                e.setUpdated(i, !0, "deleted"),
        ...
        var o = null,
          l = null;
        c.push(
          this.attachEvent("onTaskIdChange", function(i, n) {
            if (e._waitMode) {
      ...
      t.dataProcessor = i(71);
      var d,
        c = [];
      (t._dp_init = function(i) {
        t.assert(
          !this._dp,
          "The dataProcessor is already attached to this gantt instance"
        ),
          i.setTransactionMode("POST", !0),
          (i.serverProcessor +=
            (-1 != i.serverProcessor.indexOf("?") ? "&" : "?") +
            "editing=true"),
          (i._serverProcessor = i.serverProcessor),
          (i.$gantt = this),
          (i.styles = {
  ...
  function(t, e, i) {
    function n(t, e, i, n) {
      var r = t.data || this.xml._xmlNodeToJSON(t.firstChild),
        a = { add: this.addTask, isExist: this.isTaskExists };
      "links" == n && ((a.add = this.addLink), (a.isExist = this.isLinkExists)),
        a.isExist.call(this, e) || ((r.id = e), a.add.call(this, r));
    }
    function r(t, e, i, n) {
      var r = { delete: this.deleteTask, isExist: this.isTaskExists };
      "links" == n &&
        ((r.delete = this.deleteLink), (r.isExist = this.isLinkExists)),
        r.isExist.call(this, e) && r.delete.call(this, e);
    }
    function a(t, e) {
      e.attachEvent("insertCallback", s.bind(n, t)),
        e.attachEvent("updateCallback", s.bind(r, t)),
        e.attachEvent("deleteCallback", s.bind(r, t));
    }
    var s = i(0);
    t.exports = a;
  },
    ...
    (a.prototype = {
      setTransactionMode: function(t, e) {
        "object" == typeof t
          ? ((this._tMode = t.mode || this._tMode),
            n.defined(t.headers) && (this._headers = t.headers),
            n.defined(t.payload) && (this._payload = t.payload))
        ...
        if (!this._silent_mode) {
          ...
          r && "updated" == i && (i = r),
            e
              ...
              : this.is_invalid(t) ||
                (this.updatedRows.splice(n, 1),
                this.obj.setUserData(t, this.action_param, "")),
      ...
      markRow: function(t, e, i) {
        var n = "",
          r = this.is_invalid(t);
        if (
          (r && ((n = this.styles[r]), (e = !0)),
          this.callEvent("onRowMark", [t, e, i, r]) &&
            ((n = this.styles[e ? i : "clear"] + n),
            this.obj[this._methods[0]](t, n),
            r && r.details))
        ) {
      ...
      serialize: function(t, e) {
        ...
        for (var r in t)
          t.hasOwnProperty(r) &&
            (i.push(this.serialize_one(t[r], r + this.post_delim)), n.push(r));
        return (
          i.push("ids=" + this.escape(n.join(","))),
          this.$gantt.security_key &&
            i.push("dhx_security=" + this.$gantt.security_key),
          i.join("&")
        );
      },
      ...
      _sendData: function(t, e) {
        if (t) {
          if (
            !this.callEvent(
              "onBeforeDataSending",
              e ? [e, this.getState(e), t] : [null, null, t]
            )
          )
            return !1;
          ...
          var i = this,
            ...
            a =
              this.serverProcessor +
              (this._user
                ? r.urlSeparator(this.serverProcessor) +
                  [
                    "dhx_user=" + this._user,
                    "dhx_version=" + this.obj.getUserData(0, "version")
                  ].join("&")
                : ""),
          ...
          if ("GET" == this._tMode)
            ...
            delete l[this.action_param],
              ...
              r.query({
                ...
                headers: this._headers,
                callback: n,
                data: JSON.stringify({ id: e, action: o, data: l })
              });
          ...
          if (this._tSend) this._sendData(this._getAllData());
            ...
            for (var e = 0; e < this.updatedRows.length; e++)
              if (!this._in_progress[this.updatedRows[e]]) {
                ...
                if (
                  (this._beforeSendData(
                    this._getRowData(this.updatedRows[e]),
                    this.updatedRows[e]
                  ),
      ...
      _getAllData: function(t) {
        for (var e = {}, i = !1, n = 0; n < this.updatedRows.length; n++) {
          ...
          if (!this._in_progress[r] && !this.is_invalid(r)) {
            ...
            this.callEvent("onBeforeUpdate", [r, this.getState(r), a]) &&
              ((e[r] = a),
              (i = !0),
              (this._in_progress[r] = new Date().valueOf()));
          }
        }
        return i ? e : null;
      },
      ...
      findRow: function(t) {
        ...
        for (
          e = 0;
          e < this.updatedRows.length && t != this.updatedRows[e];
          e++
        );
        return e;
      },
      ...
      afterUpdateCallback: function(t, e, i, n) {
        var r = t,
          a = "error" != i && "invalid" != i;
        if (
          (a || this.set_invalid(t, i),
          this._uActions && this._uActions[i] && !this._uActions[i](n))
        )
        ...
        "wait" != this._in_progress[r]
          ? (a && this.obj.setUserData(t, this.action_param, ""),
            delete this._in_progress[r])
          : (delete this._in_progress[r],
            this.setUpdated(e, !0, this.obj.getUserData(t, this.action_param))),
      ...
      finalizeUpdate: function() {
        this._waitMode && this._waitMode--,
          ("tree" == this.obj.mytype || this.obj._h2) &&
      ...
      fullSync: function() {
        return (
          this._need_update && ((this._need_update = !1), this.loadUpdate()), !0
        );
      },
  ...
  function(t, e, i) {
    t.exports = function(t) {
      for (
        var e = [i(73), i(74), i(75), i(76), i(77), i(78)], n = 0;
        n < e.length;
        n++
      )
        e[n] && e[n](t);
  ...
  function(t, e, i) {
    ...
    t.exports = function(t) {
      ...
      function a(t) {
        t
          ? (r(!0), m.started || ((m.x = k.x), (m.y = k.y), (m.started = !0)))
          : (g && (clearInterval(g), (g = null)), r(!1), (m.started = !1));
      }
      function s(e) {
        var n = i();
        if (((!g && !p) || n || a(!1), !t.config.autoscroll || !n)) return !1;
        (k = { x: e.clientX, y: e.clientY }), !g && n && a(!0);
      }
      function o() {
        if (!i()) return a(!1), !1;
      ...
      function d(e, i) {
        ...
        e && ((r = n.x + e), (r = Math.min(n.width, r)), (r = Math.max(0, r))),
          i &&
            ((a = n.y + i), (a = Math.min(n.height, a)), (a = Math.max(0, a))),
          t.scrollTo(r, a);
      }
      var c = 50,
        h = 30,
        ...
        k = {};
      t.attachEvent("onGanttReady", function() {
        t.eventRemove(document.body, "mousemove", s),
          t.event(document.body, "mousemove", s);
      });
    };
  },
  function(t, e) {
    function i(t) {
      ...
      return (
        t.$services.getService("state").registerProvider(
          "batchUpdate",
          function() {
            return { batch_update: o };
          },
          !0
        ),
        function(t, e) {
          if (o) return void a(t);
          var i,
            s = this._dp && "off" != this._dp.updateMode;
          ...
          n.call(this, d),
            ...
            r.call(this);
          for (var c in l) this.resetProjectDates(l[c]);
          (o = !1),
            e || this.render(),
            s &&
              (this._dp.setUpdateMode(i),
          ...
          return t
            ? (this._isRecalcNeeded() && this._calcWBS(),
              t.$virtual
                ...
                : this._isGroupSort()
                  ? t.$wbs || ""
                  : (t.$wbs || (this.reset(), this._calcWBS()), t.$wbs))
            : "";
        },
              ...
              this.each(function() {
                if (this && this.getAttribute)
                  if (this.gantt || window.gantt.$root == this)
                    n.push(
                      "object" == typeof this.gantt ? this.gantt : window.gantt
                    );
                  else {
                    var t =
  ...
  function(t, e) {
    window.dhtmlx &&
      ...
      void 0 !== window.dhtmlXCellObject &&
        (dhtmlXCellObject.prototype.attachGantt = function(t, e, i) {
          i = i || window.gantt;
          var n = document.createElement("DIV");
          (n.id = "gantt_" + i.uid()),
            (n.style.width = "100%"),
            ...
            (n.firstChild.style.border = "none");
          return (
            (n = null), this.callEvent("_onContentAttach", []), this.dataObj
          );
        }),
      (t.exports = null);
  },
    ...
    function i(t) {
      ...
      function a(i, n, r) {
        for (var a = e(i, n), s = r.unit, o = {}, l = 0; l < a.length; l++)
          for (
            var d = a[l], c = t.date[s + "_start"](new Date(d.start_date));
            c < d.end_date;

          ) {
            var h = c;
            if (
              ((c = t.date.add(c, 1, s)), t.isWorkTime({ date: h, task: d }))
            ) {
              var u = h.valueOf();
              o[u] || (o[u] = { tasks: [] }), o[u].tasks.push(d);
            }
          }
        var _,
          g,
        ...
        for (var l in o)
          (_ = new Date(1 * l)),
            (g = t.date.add(_, 1, s)),
            f.push({ start_date: _, end_date: g, tasks: o[l].tasks });
        return f;
      }
      function s(t, e) {
        for (
          var i = e.$getConfig(),
            n = e.$getTemplates(),
            a = r(i.resource_property, t.id, e.getScale()),
            s = [],
            o = 0;
          o < a.length;
          o++
          ...
          if (d || c) {
            ...
            (u.className = ["gantt_resource_marker", d].join(" ")),
              (u.style.cssText = [
                "left:" + h.left + "px",
                "width:" + h.width + "px",
                "height:" + (i.row_height - 1) + "px",
                "line-height:" + (i.row_height - 1) + "px",
                "top:" + h.top + "px"
              ].join(";")),
              c && (u.innerHTML = c),
              s.push(u);
        ...
        if (s.length) {
          ...
          for (var o = 0; o < s.length; o++) _.appendChild(s[o]);
        }
        return _;
      }
      var o = {},
    ...
    t.exports = function(t) {
      function e(e) {
        if (t.config.branch_loading && t._load_url) {
          if (
            !t.getUserData(e, "was_rendered") &&
            !t.getChildren(e).length &&
            t.hasChild(e)
          )
            return !0;
        }
      ...
      (t.$data.tasksStore.hasChild = function(e) {
        return (
          ...
          (!!this.exists(e) &&
            this.getItem(e)[t.config.branch_loading_property])
        );
      }),
        t.attachEvent("onTaskOpened", function(i) {
          if (t.config.branch_loading && t._load_url && e(i)) {
            ...
            t.load(
              n + r + "parent_id=" + encodeURIComponent(i),
              this._load_type,
              function() {
                a && t.scrollTo(null, a);
              }
  ...
  function(t, e, i) {
    ...
    t.exports = function(t) {
      i(81)(t),
        (n.prototype.getGridColumns = function() {
          for (
            var t = this.$getConfig(), e = t.columns, i = [], n = 0;
            n < e.length;
            n++
          )
            e[n].hide || i.push(e[n]);
      ...
      t._waiAria = {
        ...
        _taskCommonAttr: function(i, n) {
          i.start_date &&
            ...
            (n.setAttribute(
              "aria-label",
              e(t.templates.tooltip_text(i.start_date, i.end_date, i))
            ),
            t.isReadonly(i) && n.setAttribute("aria-readonly", !0),
            i.$dataprocessor_class && n.setAttribute("aria-busy", !0),
            n.setAttribute(
              "aria-selected",
              t.getState().selected_task == i.id ||
              (t.isSelectedTask && t.isSelectedTask(i.id))
                ? "true"
                : "false"
            ));
        },
        setTaskBarAttr: function(e, i) {
          this._taskCommonAttr(e, i),
            !t.isReadonly(e) &&
              t.config.drag_move &&
              (e.id != t.getState().drag_id
                ? i.setAttribute("aria-grabbed", !1)
                : i.setAttribute("aria-grabbed", !0));
        },
        taskRowAttr: function(e, i) {
          this._taskCommonAttr(e, i),
            !t.isReadonly(e) &&
              t.config.order_branch &&
              i.setAttribute("aria-grabbed", !1),
            i.setAttribute("role", "row"),
            i.setAttribute("aria-level", e.$level),
            t.hasChild(e.id) &&
              i.setAttribute("aria-expanded", e.$open ? "true" : "false");
        },
        linkAttr: function(i, n) {
          var r = t.config.links,
            ...
            o =
              t.locale.labels.link +
              " " +
              t.templates.drag_link(i.source, s, i.target, a);
        ...
        gridScaleCellAttrString: function(e, i) {
          ...
          if ("add" == e.name)
            ...
            t._sort &&
              t._sort.name == e.name &&
              ("asc" == t._sort.direction
                ? (r["aria-sort"] = "ascending")
                : (r["aria-sort"] = "descending")),
              (n = this.getAttributeString(r));
          }
          return n;
        },
  ...
  function(t, e) {
    t.exports = function(t) {
      t.isReadonly = function(t) {
        return (
          (!t || !t[this.config.editable_property]) &&
          ((t && t[this.config.readonly_property]) || this.config.readonly||t.is_readonly==null?!1:t.is_readonly)
        );
      };
    };
  },
      ...
      (t.load = function(e, i, n) {
        ...
        arguments.length >= 3
          ...
          : "string" == typeof arguments[1]
            ? (r = arguments[1])
            : "function" == typeof arguments[1] && (a = arguments[1]),
          (this._load_type = r),
        ...
        (t._process_loading = function(t) {
          t.collections && this._load_collections(t.collections),
            this.$data.tasksStore.parse(t.data);
          var e = t.links || (t.collections ? t.collections.links : []);
          if (
            (this.$data.linksStore.parse(e),
        ...
        (t.json = {
          ...
          _copyObject: function(e) {
            ...
            for (var r in e)
              "$" != r.charAt(0) &&
                ((i[r] = e[r]),
                n.isDate(i[r]) && (i[r] = t.templates.xml_format(i[r])));
            return i;
          },
          serialize: function() {
            var e = [],
        ...
        (t.xml = {
          _xmlNodeToJSON: function(t, e) {
            ...
            if (!e) {
              for (var n = 0; n < t.childNodes.length; n++) {
                ...
                1 == r.nodeType &&
                  (i[r.tagName] = r.firstChild ? r.firstChild.nodeValue : "");
              }
          ...
          _getCollections: function(e) {
            for (
              var i = {}, n = t.ajax.xpath("//coll_options", e), r = 0;
              r < n.length;
              r++
            )
              for (
                var a = n[r].getAttribute("for"),
                  s = (i[a] = []),
                  o = t.ajax.xpath(".//item", n[r]),
                  l = 0;
                l < o.length;
                l++
              ) {
        ...
        (t.oldxml = {
          parse: function(e, i) {
            ...
            for (
              ...
              "project" == o.tagName
                ? (r[s].parent = "project-" + o.getAttribute("id"))
                : (r[s].parent = o.parentNode.getAttribute("id"));
            }
            ...
            for (var s = 0; s < r.length; s++) {
              var l = r[s];
              (l.start_date = l.startdate || l.est),
        ...
        (t.serverList = function(t, e) {
          return (
            e
              ? (this.serverList[t] = e.slice(0))
              : this.serverList[t] || (this.serverList[t] = []),
            this.serverList[t]
          );
        });
    };
  ...
  function(t, e, i) {
    ...
    (n.prototype = {
      ...
      _getDayHoursForMultiple: function(t, e) {
        for (
          var i = [],
            ...
            r = 0,
            a = !1,
            s = this.$gantt.date.day_start(new Date(e)),
            o = 0;
          o < 24;
          o++
        )
          (a = t.reduce(function(t, e) {
            ...
            a
              ? (n
                ...
                (n = !1))
              : n || (n = !0),
            (s = this.$gantt.date.add(s, 1, "hour"));
        return i.length || (i = !1), i;
      },
      mergeCalendars: function() {
        var t,
          e = this.createCalendar(),
          i = [],
          n = Array.prototype.slice.call(arguments, 0);
        (e.worktime.hours = [0, 24]), (e.worktime.dates = {});
        var r = this.$gantt.date.day_start(new Date(2592e5));
        for (t = 0; t < 7; t++)
          (i = this._getDayHoursForMultiple(n, r)),
            (e.worktime.dates[t] = i),
            (r = this.$gantt.date.add(r, 1, "day"));
        for (var a = 0; a < n.length; a++)
          for (var s in n[a].worktime.dates)
            +s > 1e4 &&
              ((i = this._getDayHoursForMultiple(n, new Date(+s))),
              (e.worktime.dates[s] = i));
        return e;
      },
      ...
      createCalendar: function(t) {
        ...
        r.mixin(e, i);
        var n = r.uid(),
          o = { id: n + "", worktime: this._convertWorktimeSettings(e) },
          l = new s(this.$gantt, a(this.$gantt));
        return (
          r.mixin(l, o), l._tryChangeCalendarSettings(function() {}) ? l : null
        );
      },
      getCalendar: function(t) {
        return (
          (t = t || "global"), this.createDefaultCalendars(), this._calendars[t]
        );
      },
      ...
      addCalendar: function(t) {
        ...
        return (
          ...
          i.worktimes || (i.worktimes = {}),
          (i.worktimes[t.id] = t.worktime),
          t.id
        );
      },
      deleteCalendar: function(t) {
        ...
        return (
          ...
          (!!this._calendars[t] &&
            ...
            e.worktimes && e.worktimes[t] && delete e.worktimes[t],
            !0))
        );
      },
      ...
      defaults: {
        global: {
          id: "global",
          worktime: { hours: [8, 17], days: [0, 1, 1, 1, 1, 1, 0] }
        },
        fulltime: {
          id: "fulltime",
  ...
  function(t, e, i) {
    ...
    (n.prototype = {
      ...
      _checkIfWorkingUnit: function(t, e, i) {
        return (
          void 0 === i && (i = this._getUnitOrder(e)),
          void 0 === i ||
            (!(i && !this._isWorkTime(t, this.units[i - 1], i - 1)) &&
              (!this["_is_work_" + e] || this["_is_work_" + e](t)))
        );
      },
      ...
      _is_work_hour: function(t) {
        for (
          var e = this._getWorkHours(t), i = t.getHours(), n = 0;
          n < e.length;
          n += 2
        ) {
      ...
      _getWorkUnitsBetweenGeneric: function(t, e, i, n) {
        ...
        var o,
          ...
          c = null,
          h = !1;
        (o = r[i + "_start"](new Date(a))),
          o.valueOf() != a.valueOf() && (h = !0);
        var u = !1;
        (l = r[i + "_start"](new Date(e))),
          l.valueOf() != e.valueOf() && (u = !0);
        for (var _ = !1; a.valueOf() < s.valueOf(); )
          (c = this._nextDate(a, i, n)),
            (_ = c.valueOf() > s.valueOf()),
            this._isWorkTime(a, i) &&
              ((h || (u && _)) &&
                ((o = r[i + "_start"](new Date(a))), (l = r.add(o, n, i))),
              h
                ? ((h = !1),
                  (c = this._nextDate(o, i, n)),
                  (d +=
                    (l.valueOf() - a.valueOf()) / (l.valueOf() - o.valueOf())))
                : u && _
                  ? ((u = !1),
                    (d +=
                      (s.valueOf() - a.valueOf()) /
      ...
      _getWorkHoursForRange: function(t, e) {
        for (
          var i = 0, n = new Date(t), r = new Date(e);
          n.valueOf() < r.valueOf();

        )
          this._isWorkTime(n, "day") && (i += this._getHoursPerDay(n)),
      ...
      _getWorkUnitsBetweenHours: function(t, e, i, n) {
        ...
        var s = new Date(r),
          o = this.$gantt.date.add(
            this.$gantt.date.day_start(new Date(r)),
            1,
            "day"
          );
      ...
      _tryChangeCalendarSettings: function(t) {
        ...
        return (
          t(),
          !this._isEmptyCalendar(this._getCalendar()) ||
            (this.$gantt.assert(
              !1,
              "Invalid calendar settings, no worktime available"
            ),
            this._setCalendar(JSON.parse(e)),
      ...
      _isEmptyCalendar: function(t) {
        ...
        for (var a = [], r = 0; r < i.length; r++) i[r] < 10 && a.push(i[r]);
        a.sort();
        for (var r = 0; r < 7; r++) a[r] != r && (n = !1);
      ...
      _getWorkHours: function(t) {
        var e = this._timestamp({ date: t }),
          i = !0,
          n = this._getCalendar();
        return (
          void 0 !== n.dates[e]
            ? (i = n.dates[e])
            : void 0 !== n.dates[t.getDay()] && (i = n.dates[t.getDay()]),
          !0 === i ? n.hours : i || []
        );
      },
        ...
        return this._tryChangeCalendarSettings(
          a.bind(function() {
            var e = void 0 === t.hours || t.hours,
              i = this._timestamp(t);
            null !== i
              ? (this._getCalendar().dates[i] = e)
              : (this._getCalendar().hours = e),
              this._workingUnitsCache.clear();
          }, this)
        );
      },
      ...
      _isWorkTime: function(t, e, i) {
        ...
        return (
          -1 == n &&
            ((n = this._checkIfWorkingUnit(t, e, i)),
            this._workingUnitsCache.put(e, t, n)),
          n
        );
      },
      isWorkTime: function() {
      ...
      calculateDuration: function() {
        ...
        return (
          (e =
            "hour" == t.unit
              ? this._getWorkUnitsBetweenHours(
                  t.start_date,
                  t.end_date,
                  t.unit,
                  t.step
                )
              : this._getWorkUnitsBetweenGeneric(
                  t.start_date,
                  t.end_date,
                  t.unit,
                  t.step
      ...
      _calculateEndDate: function(t, e, i, n) {
        ...
        for (n = n || 1, e = Math.abs(1 * e); a < e; ) {
          ...
          this._isWorkTime(
            n > 0 ? new Date(s.valueOf() - 1) : new Date(s.valueOf() + 1),
            i
          ) && a++,
            (r = s);
        }
      ...
      _getClosestWorkTime: function(t) {
        ...
        "past" == t.dir && (l = -1);
        for (
          var d = this._getUnitOrder(e), c = this.units[d - 1];
          !this._isWorkTime(i, e);
          ...
          if (
            ((i = this.$gantt.date.add(i, l, e)),
            (i = this.$gantt._correct_dst_change(i, u, l, e)),
            this.$gantt.date[e + "_start"] &&
              (i = this.$gantt.date[e + "_start"](i)),
            o && (a ? (n = i) : (r = i)),
            (a = !a),
            ++s > 3e3)
          )
        ...
        return (
          (i != r && "past" != t.dir) || (i = this.$gantt.date.add(i, 1, e)), i
        );
      }
    }),
      (t.exports = n);
  ...
  function(t, e, i) {
    function n(t) {
      (this.$gantt = t.$gantt),
        (this.argumentsHelper = r(this.$gantt)),
        (this.calendarManager = t),
        (this.$disabledCalendar = new a(this.$gantt, this.argumentsHelper));
    }
    var r = i(21),
      a = i(90);
    (n.prototype = {
      _getCalendar: function(t) {
        ...
        if (this.$gantt.$services.config().work_time) {
          ...
          t.task
            ? (e = i.getTaskCalendar(t.task))
            : t.id
              ? (e = i.getTaskCalendar(t))
              : t.calendar && (e = t.calendar),
            e || (e = i.getTaskCalendar());
  ...
  function(t, e) {
    ...
    (i.prototype = {
      ...
      _calculateDuration: function(t, e, i, n) {
        var r = this.$gantt.date,
          a = { week: 6048e5, day: 864e5, hour: 36e5, minute: 6e4 },
          s = 0;
        if (a[i]) s = Math.round((e - t) / (n * a[i]));
        else {
          for (
            var o = new Date(t), l = new Date(e);
            o.valueOf() < l.valueOf();
      ...
      hasDuration: function() {
        ...
        return (
          !!n &&
          ((e = new Date(e)), (i = new Date(i)), e.valueOf() < i.valueOf())
        );
      },
      calculateEndDate: function() {
        var t = this.argumentsHelper.calculateEndDateArguments.apply(
    ...
    t.exports = function(t) {
      (t.isUnscheduledTask = function(t) {
        ...
        (t.isTaskVisible = function(e) {
          ...
          return (
            !!(
              (+i.start_date <= +this._max_date &&
                +i.end_date >= +this._min_date) ||
              t._isAllowedUnscheduledTask(i)
        ...
        (t._set_default_task_timing = function(e) {
          (e.start_date =
            e.start_date || t._defaultTaskDate(e, this.getParent(e))),
        ...
        (t.createTask = function(e, i, n) {
          if (
            ...
            e.start_date || (e.start_date = t._defaultTaskDate(e, i)),
          ...
          return this.callEvent("onTaskCreated", [e])
        ...
        (t._update_flags = function(e, i) {
          ...
          void 0 === e
            ...
            : (this._lightbox_id == e && (this._lightbox_id = i),
              n.getSelectedId() == e &&
                n.silent(function() {
              ...
              this._tasks_dnd &&
                ...
                (this._tasks_dnd.drag.id = i));
        }),
        (t._get_task_timing_mode = function(t, e) {
          var i = this.getTaskType(t.type),
            n = { type: i, $no_start: !1, $no_end: !1 };
          return e || i != t.$rendered_type
            ? (i == this.config.types.project
                ? (n.$no_end = n.$no_start = !0)
                : i != this.config.types.milestone &&
                  ((n.$no_end = !(t.end_date || t.duration)),
                  (n.$no_start = !t.start_date),
                  this._isAllowedUnscheduledTask(t) &&
                    (n.$no_end = n.$no_start = !1)),
              n)
            : ((n.$no_start = t.$no_start), (n.$no_end = t.$no_end), n);
        }),
        (t._init_task_timing = function(e) {
          var i = t._get_task_timing_mode(e, !0),
            ...
            r = i.type;
          n &&
            ((e.$no_start = i.$no_start),
            (e.$no_end = i.$no_end),
            (e.$rendered_type = i.type)),
            n &&
              r != this.config.types.milestone &&
              r == this.config.types.project &&
              this._set_default_task_timing(e),
            r == this.config.types.milestone && (e.end_date = e.start_date),
            e.start_date &&
              e.end_date &&
          ...
          return (
            this.eachTask(function(e) {
              this.getTaskType(e.type) == t.config.types.project ||
                ...
                (e.start_date &&
                  !e.$no_start &&
                  (!i || i > e.start_date.valueOf()) &&
                  (i = e.start_date.valueOf()),
                e.end_date &&
                  !e.$no_end &&
                  (!n || n < e.end_date.valueOf()) &&
                  (n = e.end_date.valueOf()));
            }, r),
            {
        ...
        (t.roundDate = function(e) {
          ...
          if (
            ...
            (d = Math.floor(t.columnIndexByDate(r))),
              i.trace_x[d] || ((d -= 1), i.rtl && (d = 0)),
              (l = new Date(i.trace_x[d])),
              (o = t.date.add(l, a, s));
          else {
            for (
              d = Math.floor(t.columnIndexByDate(r)),
                o = t.date[s + "_start"](new Date(i.min_date)),
                i.trace_x[d] && (o = t.date[s + "_start"](i.trace_x[d]));
              +o < +r;

            ) {
              o = t.date[s + "_start"](t.date.add(o, a, s));
              var c = o.getTimezoneOffset();
              (o = t._correct_dst_change(o, c, o, s)),
                t.date[s + "_start"] && (o = t.date[s + "_start"](o));
            }
      ...
      (t._lightbox_methods = {}),
        ...
        (t.getLightbox = function(e) {
          if (
            ...
            !this._lightbox || this.getLightboxType() != this.getTaskType(e))
          ) {
            this._lightbox_type = this.getTaskType(e);
            var i = document.createElement("DIV");
            i.className = "gantt_cal_light";
            var n = this._is_lightbox_timepicker();
            (t.config.wide_form || n) &&
              (i.className += " gantt_cal_light_wide"),
              n &&
                ((t.config.wide_form = !0),
                (i.className += " gantt_cal_light_full")),
              (i.style.visibility = "hidden");
            for (
              var r,
                a = this._lightbox_template,
                s = this.config.buttons_left,
                o = 0;
              o < s.length;
              o++
            ) {
              var l = this.config._migrate_buttons[s[o]]
                ? this.config._migrate_buttons[s[o]]
                : s[o];
              (r = this._waiAria.lightboxButtonAttrString(l)),
                (a +=
                  "<div " +
                  r +
            ...
            for (var o = 0; o < s.length; o++) {
              ...
              (r = this._waiAria.lightboxButtonAttrString(l)),
                (a +=
                  "<div " +
                  r +
                  " class='gantt_btn_set gantt_right_btn_set " +
                  l +
                  "_set' style='float:right;'><div dhx_button='1' class='" +
                  l +
                  "'></div><div>" +
                  this.locale.labels[l] +
                  "</div></div>");
            ...
            (a += "</div>"),
              ...
              t.config.drag_lightbox &&
                ((i.firstChild.onmousedown = t._ready_to_dnd),
                (i.firstChild.onselectstart = function() {
                  return !1;
                }),
                (i.firstChild.style.cursor = "pointer"),
                t._init_dnd_events()),
              document.body.insertBefore(i, document.body.firstChild),
              (this._lightbox = i);
            var d = this._get_typed_lightbox_config(e);
            a = this._render_sections(d);
            for (
              var c = i.getElementsByTagName("div"), o = 0;
              o < c.length;
              o++
            ) {
              var h = c[o];
            ...
            for (var o = 0; o < d.length; o++) {
              var u = d[o];
              if (u.id && document.getElementById(u.id)) {
                var _ = document.getElementById(u.id),
                  g = _.querySelector("label"),
                  f = _.nextSibling;
                if (f) {
                  var p = f.querySelector("input, select, textarea");
                  p &&
                    ((u.inputId = p.id || "input_" + t.uid()),
                    p.id || (p.id = u.inputId),
                    g.setAttribute("for", u.inputId));
                }
              }
            }
            this.resizeLightbox(),
        ...
        (t._render_sections = function(t) {
          for (var e = "", i = 0; i < t.length; i++) {
            ...
            if (n) {
              ...
              t[i].button &&
                (a =
                  "<div class='gantt_custom_button' index='" +
                  i +
                ...
                this.config.wide_form &&
                  (e += "<div class='gantt_wrap_section' " + r + ">"),
                (e +=
                  "<div id='" +
                  t[i].id +
                  "' class='gantt_cal_lsection'><label>" +
                  a +
                  this.locale.labels["section_" + t[i].name] +
                  "</label></div>" +
                  n.render.call(this, t[i])),
                (e += "</div>");
            }
          }
          return e;
        ...
        (t.resizeLightbox = function() {
          ...
          if (t) {
            ...
            (e.style.height = "0px"),
              ...
              (t.style.height =
                e.scrollHeight + this.config.lightbox_additional_height + "px"),
              (e.style.height = e.scrollHeight + "px");
          }
        }),
          ...
          if (t) {
            ...
            (t.style.top = e
              ...
              document.documentElement.scrollWidth > document.body.offsetWidth
                ? (t.style.left =
                    Math.round(
                      i + (document.body.offsetWidth - t.offsetWidth) / 2
                    ) + "px")
                : (t.style.left =
                    Math.round(
          ...
          (t.lightbox_events = {}),
              ...
              if (i.getAttribute("dhx_button"))
                ...
                if (-1 != o.indexOf("gantt_custom_button"))
                  if (-1 != o.indexOf("gantt_custom_button_"))
                    for (
                      n = i.parentNode.getAttribute("index"), s = i;
                      s &&
                      -1 == r.getClassName(s).indexOf("gantt_cal_lsection");

                    )
                      s = s.parentNode;
                  else
                    (n = i.getAttribute("index")),
                      (s = i.parentNode),
                      (i = i.firstChild);
                var l = t._get_typed_lightbox_config();
                n &&
                  ((n *= 1),
                  (a = t.form_blocks[l[1 * n].type]),
                  a.button_click(n, i, s, s.nextSibling));
              }
            }),
            this.event(t.getLightbox(), "click", function(e) {
              ...
              var i = e.target ? e.target : e.srcElement,
                n = r.getClassName(i);
              return (
                n || ((i = i.previousSibling), (n = r.getClassName(i))),
                i &&
                  n &&
                  0 === n.indexOf("gantt_btn_set") &&
                  ((i = i.firstChild), (n = r.getClassName(i))),
                !(!i || !n) &&
                  (t.defined(t.lightbox_events[i.className])
                    ? t.lightbox_events[i.className]
                    : t.lightbox_events.default)(e, i)
              );
            }),
        ...
        (t._save_lightbox = function() {
          ...
          this.callEvent("onLightboxSave", [this._lightbox_id, t, !!t.$new]) &&
            (t.$new
              ? (delete t.$new, this.addTask(t))
        ...
        (t._set_lightbox_values = function(e, i) {
          ...
          t.templates.lightbox_header
            ? (a.push(""),
              a.push(t.templates.lightbox_header(n.start_date, n.end_date, n)),
              (r[1].innerHTML = ""),
            ...
            : (a.push(this.templates.task_time(n.start_date, n.end_date, n)),
              a.push(
                (
                  this.templates.task_text(n.start_date, n.end_date, n) || ""
                ).substr(0, 70)
              ),
            ...
            (r[1].innerHTML = a[0]),
            (r[2].innerHTML = a[1]),
            t._waiAria.lightboxHeader(i, a.join(" "));
          for (
            var s = this._get_typed_lightbox_config(this.getLightboxType()),
              o = 0;
            o < s.length;
            o++
          ) {
        ...
        (t._move_while_dnd = function(e) {
          if (t._dnd_start_lb) {
            ...
            (i.style.top = t._lb_start[1] + n[1] - t._dnd_start_lb[1] + "px"),
              (i.style.left =
                t._lb_start[0] + n[0] - t._dnd_start_lb[0] + "px");
          }
        }),
        (t._ready_to_dnd = function(e) {
          var i = t.getLightbox();
          (t._lb_start = [
            parseInt(i.style.left, 10),
            parseInt(i.style.top, 10)
          ]),
            (t._dnd_start_lb =
              e && e.target
                ? [e.pageX, e.pageY]
        ...
        (t.form_blocks = {
          getTimePicker: function(e, i) {
            ...
            if (!n) {
              ...
              a.getSecondsInUnit(s) < a.getSecondsInUnit("day") &&
                n.push("%H:%i");
            }
              ...
              switch (_) {
                case "%Y":
                  ...
                  e.year_range &&
                    (isNaN(e.year_range)
                      ? e.year_range.push &&
                        ((v = e.year_range[0]), (m = e.year_range[1]))
                      : (f = e.year_range)),
                    (f = f || 10),
                    (p = p || Math.floor(f / 2)),
                    (v = v || l.getFullYear() - p),
                ...
                case "%H:%i":
                  ...
                  for (e._time_values = []; k < d; )
                    (g +=
                      ...
                      k +
                      "'>" +
                      this.templates.time_picker(l) +
                      "</option>"),
                      e._time_values.push(k),
                      l.setTime(
                        l.valueOf() + 60 * this._get_timepicker_step() * 1e3
                      ),
                      (k =
                        24 * (l.getDate() != y ? 1 : 0) * 60 +
                        60 * l.getHours() +
                        l.getMinutes());
              }
              if (g) {
          ...
          _fill_lightbox_select: function(e, i, n, r, a) {
            if (
              ((e[i + r[0]].value = n.getDate()),
              (e[i + r[1]].value = n.getMonth()),
              (e[i + r[2]].value = n.getFullYear()),
              t.defined(r[3]))
            ) {
              var s = 60 * n.getHours() + n.getMinutes();
              s =
                Math.round(s / t._get_timepicker_step()) *
          ...
          select: {
            ...
            set_value: function(t, e, i, n) {
              ...
              !r._dhx_onchange &&
                n.onchange &&
                ((r.onchange = n.onchange), (r._dhx_onchange = !0)),
          ...
          time: {
            render: function(t) {
              ...
              return (
                i.push(e),
                t.single_date
                  ? ((e = this.form_blocks.getTimePicker.call(this, t, !0)),
                    i.push("<span></span>"))
                  : i.push(
            ...
            set_value: function(e, i, n, r) {
              ...
              "string" == typeof c && (c = { start_date: c });
              var h = n[c.start_date] || new Date(),
                u =
                  n[c.end_date] ||
                  t.calculateEndDate({ start_date: h, duration: 1, task: n });
              this.form_blocks._fill_lightbox_select(s, 0, h, o, a),
            ...
            get_value: function(e, i, n) {
              ...
              var h = t._resolve_default_mapping(n),
                u = { start_date: new Date(d), end_date: new Date(c) };
          ...
          duration: {
            ...
            set_value: function(e, i, n, r) {
              ...
              (h[0].onclick = t.bind(function() {
                ...
                (l[2].onchange = a),
                l[3] && (l[3].onchange = a),
                (c.onkeydown = t.bind(function(t) {
                  t = t || window.event;
                  var e = t.charCode || t.keyCode || t.which;
                  return 40 == e
                    ? (s(-1 * this.config.duration_step), !1)
                    : 38 == e
                      ? (s(1 * this.config.duration_step), !1)
                      : void window.setTimeout(function(t) {
                          a();
                        }, 1);
                }, this)),
                (c.onchange = t.bind(function(t) {
                  a();
                }, this));
              var g = t._resolve_default_mapping(r);
              "string" == typeof g && (g = { start_date: g });
              var f = n[g.start_date] || new Date(),
                p =
                  n[g.end_date] ||
                  t.calculateEndDate({ start_date: f, duration: 1, task: n }),
                v =
                  Math.round(n[g.duration]) ||
                  t.calculateDuration({ start_date: f, end_date: p, task: n });
              t.form_blocks._fill_lightbox_select(l, 0, f, _, o),
                (c.value = v),
                a();
            },
            _get_start_date: function(e, i) {
              ...
              if (t.defined(r[3])) {
                ...
                isNaN(l) &&
                  ...
                  (l = parseInt(o.getAttribute("data-value"), 10)),
                  (a = Math.floor(l / 60)),
                  (s = l % 60);
              }
              return new Date(
            ...
            get_value: function(e, i, n) {
              var r = t.form_blocks.duration._get_start_date(e, n),
                ...
                s = t.calculateEndDate({ start_date: r, duration: a, task: i }),
          ...
          parent: {
            _filter: function(e, i, n) {
              ...
              for (var a = 0; a < e.length; a++) {
                var s = e[a];
                (s.id == n || t.isChildOf(s.id, n) || !1 === r(s.id, s)) &&
                  (e.splice(a, 1), a--);
              }
              return e;
            },
            _display: function(e, i) {
              ...
              i &&
                ((n = t.getTaskByTime()),
                e.allow_root &&
                  n.unshift({ id: t.config.root_id, text: e.root_label || "" }),
                (n = this._filter(n, e, i)),
                e.sort && n.sort(e.sort));
              for (
                var a = e.template || t.templates.task_text, s = 0;
                s < n.length;
                s++
              ) {
            ...
            set_value: function(e, i, n, r) {
              ...
              return (
                ...
                t.form_blocks.select.set_value.apply(t, [s, i, n, r])
              );
            },
            get_value: function() {
        ...
        (t._get_typed_lightbox_config = function(e) {
          void 0 === e && (e = this.getLightboxType());
          var i = n.call(this, e);
          return t.config.lightbox[i + "_sections"]
            ? t.config.lightbox[i + "_sections"]
        ...
        var i = e,
          n = {
            ...
            set_value: function(e, r, a, s) {
              ...
              if (
                ...
                ("start_date" == o.start_date &&
                  this._isAllowedUnscheduledTask(a))
              ) {
                n.disable(e, s);
                var l = {};
            ...
            update_block: function(e, i) {
              if (
                (t.callEvent("onSectionToggle", [t._lightbox_id, i]),
                (e.style.display = i.disabled ? "none" : "block"),
                i.button)
              ) {
                var n = e.previousSibling.querySelector(
                    ".gantt_custom_button_label"
                  ),
                  r = t.locale.labels,
                  a = i.disabled
                    ? r[i.name + "_enable_button"]
                    : r[i.name + "_disable_button"];
                n.innerHTML = a;
              }
              t.resizeLightbox();
            },
      ...
      (t.getTaskType = function(e) {
        ...
        (t.form_blocks.typeselect = {
          render: function(e) {
            ...
            for (var s in i)
              !1 == !a(s, i[s]) && r.push({ key: i[s], label: n["type_" + s] });
            e.options = r;
            var o = e.onchange;
            return (
              (e.onchange = function() {
    ...
    t.exports = function(t) {
      ...
      (t._cached_functions = {
        ...
        setup: function(t) {
          ...
          "auto" == this.mode
            ? t.config.highlight_critical_path && (e = i)
            : !0 === this.mode && (e = i),
            this.wrap_methods(e, t);
        },
        update_if_changed: function(t) {
          (this.critical_path_mode != t.config.highlight_critical_path ||
  ...
  function(t, e) {
    ...
    function n(t, e) {
      ...
      l[1] && !e.defined(l[1].width) && (l[1].width = o._second_column_width),
        l[2] && !e.defined(l[2].width) && (l[2].width = o._third_column_width);
      for (var a = 0; a < l.length; a++) {
        var d = l[a];
        "add" == d.name &&
          (d.width || (d.width = 44),
          (e.defined(d.min_width) && e.defined(d.max_width)) ||
            ((d.min_width = d.min_width || d.width),
            (d.max_width = d.max_width || d.width)),
          d.min_width && (d.min_width = +d.min_width),
          d.max_width && (d.max_width = +d.max_width),
          d.width &&
            ((d.width = +d.width),
            (d.width =
              d.min_width && d.min_width > d.width ? d.min_width : d.width),
            (d.width =
              d.max_width && d.max_width < d.width ? d.max_width : d.width)));
      }
      o.config.task_height &&
        (e.config.task_height = o.config.task_height || "full"),
        o._lightbox_template && (e._lightbox_template = o._lightbox_template),
        o._redefine_lightbox_buttons &&
          ((e.config.buttons_right =
            o._redefine_lightbox_buttons.buttons_right),
          (e.config.buttons_left = o._redefine_lightbox_buttons.buttons_left)),
        e.resetLightbox();
    }
    t.exports = function(t) {
      t.resetSkin ||
    ...
    t.exports = function(t) {
      (t.skins.material = {
        ...
        t.attachEvent("onAfterTaskDrag", function(e) {
          ...
          i &&
            ((i.className += " gantt_drag_animation"),
            setTimeout(function() {
  ...
  function(t, e) {
    t.exports = function(t) {
      ...
      t._touch_events = function(n, r, a) {
        ...
        function o(e) {
          ...
          if (n && t.isTaskVisible(e))
            for (var r = 0; r < i.length; r++)
              if (
                (n = i[r].rendered[e]) &&
                n.getAttribute("task_id") &&
                n.getAttribute("task_id") == e
              ) {
                var a = n.cloneNode(!0);
                (g = n),
                  (i[r].rendered[e] = a),
        ...
        for (
          var l, d = 0, c = !1, h = !1, u = null, _ = null, g = null, f = 0;
          f < i.length;
          f++
        )
        ...
        (i = []),
              ...
              if (!a(i) && c) {
                ...
                if (!t._prevent_touch_scroll) {
                  if (o && u) {
                    ...
                    if (
                      (!h &&
                        (Math.abs(g) > 5 || Math.abs(f) > 5) &&
                        ((t._touch_scroll_active = h = !0),
                        (d = 0),
                        (l = t.getScrollState())),
                      h)
                    ) {
          ...
          i.push([
            ...
            function(i) {
              if (!a(i)) {
                if (i.touches && i.touches.length > 1) return void (c = !1);
                (u = r(i)),
                  t._locate_css(u, "gantt_hor_scroll") ||
                    t._locate_css(u, "gantt_ver_scroll") ||
                    (c = !0);
                var n = e();
                _ = setTimeout(function() {
                  ...
                  n &&
                    e &&
                    !t._locate_css(u, "gantt_link_control") &&
                    !t._locate_css(u, "gantt_grid_data") &&
                    (n.on_mouse_down(u),
                    n.drag &&
                      n.drag.start_drag &&
                      (o(e),
            ...
            function(i) {
              if (!a(i)) {
                ...
                if (
                  (o && o.on_mouse_up(n),
                  g &&
                    (t.refreshTask(t.locate(g)),
                    g.parentNode &&
                      (g.parentNode.removeChild(g), t._touch_feedback())),
                  (t._touch_scroll_active = c = h = !1),
                  (g = null),
                  u && d)
                ) {
                  var l = new Date();
                  if (l - d < 500) {
                    t.$services.getService("mouseEvents").onDoubleClick(u),
                      s(i);
                  } else d = l;
                } else d = new Date();
              }
        ...
        for (var f = 0; f < i.length; f++) t.event(i[f][0], i[f][1], i[f][2]);
      };
    };
  },
  function(t, e) {
    ...
    t.exports = function(t) {
      ...
      (t.assert = i(108)(t)),
        (t.init = function(e, i, r) {
          i &&
            r &&
            ((this.config.start_date = this._min_date = new Date(i)),
            (this.config.end_date = this._max_date = new Date(r))),
            this.date.init(),
            this.config.scroll_size ||
              (this.config.scroll_size = n.getScrollSize() || 1);
          var a;
        ...
        (t._reinit = function(i) {
          this.callEvent("onBeforeGanttReady", []),
            ...
            this.$layout && (this.$layout.destructor(), this.$ui.reset()),
            (this.$root = n.toNode(i)),
            ...
            this.$layout.attachEvent("onBeforeResize", function() {
              for (
                var e = t.$services.getService("datastores"), i = 0;
                i < e.length;
                i++
              )
        ...
        (t.render = function() {
          ...
          var r = null;
          if (
            (n && (r = t.dateFromPos(n + this.config.task_scroll_offset)),
            e(this),
            (this.$layout.$config.autosize = this.config.autosize),
            this.$layout.resize(),
            this.config.preserve_scroll && i && n)
          ) {
            var a = t.getScrollState();
            (+r == +t.dateFromPos(a.x) && a.y == i.y) ||
              (r && this.showDate(r), i.y && t.scrollTo(void 0, i.y));
          }
        ...
        (t._get_link_type = function(e, i) {
          ...
          return (
            e && i
              ? (n = t.config.links.start_to_start)
              : !e && i
                ? (n = t.config.links.finish_to_start)
                : e || i
                  ? e && !i && (n = t.config.links.start_to_finish)
                  : (n = t.config.links.finish_to_finish),
            n
          );
        }),
        (t.isLinkAllowed = function(t, e, i, n) {
          ...
          if (
            !(r =
              "object" == typeof t
                ? t
                : { source: t, target: e, type: this._get_link_type(i, n) })
          )
            return !1;
          ...
          return (
            this.checkEvent("onLinkValidation") &&
              (a = this.callEvent("onLinkValidation", [r])),
            a
          );
        }),
        ...
        (t._is_icon_open_click = function(t) {
          ...
          return (
            -1 !== i.indexOf("gantt_tree_icon") &&
            (-1 !== i.indexOf("gantt_close") || -1 !== i.indexOf("gantt_open"))
          );
        });
    };
  },
      ...
      return function(e, i) {
        e ||
          (t.config.show_errors &&
            !1 !== t.callEvent("onError", [i]) &&
            t.message({ type: "error", text: i, expire: -1 }));
      };
    };
  },
  function(t, e) {
    function i(t) {
      t.destructor = function() {
        ...
        for (var e in this) 0 === e.indexOf("$") && delete this[e];
      };
    }
    t.exports = i;
  },
  function(t, e) {
    t.exports = function(t) {
      ...
      for (
        ...
        window.dhtmlx[i[r]] ||
          (n.push(i[r]),
          (dhtmlx[i[r]] = (function(i) {
            return function() {
              return e("dhtmlx." + i, "gantt." + i), t[i].apply(t, arguments);
            };
          })(i[r])));
      t.attachEvent("onDestroy", function() {
        for (var t = 0; t < n.length; t++) delete window.dhtmlx[n[t]];
        n = null;
      }),
        window.dataProcessor ||
          ((window.dataProcessor = function(i) {
            return (
              e("new dataProcessor(url)", "new gantt.dataProcessor(url)"),
