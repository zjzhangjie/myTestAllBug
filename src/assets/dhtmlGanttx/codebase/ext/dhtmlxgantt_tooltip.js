    ...
    0: function(t, e) {
      function o(t) {
        ...
        if (t.getBoundingClientRect) {
          ...
          (e = r.top + s - u),
            ...
            (n = document.body.offsetHeight - r.bottom);
        } else {
          for (; t; )
            (e += parseInt(t.offsetTop, 10)),
              (o += parseInt(t.offsetLeft, 10)),
              (t = t.offsetParent);
          (i = document.body.offsetWidth - t.offsetWidth - o),
            (n = document.body.offsetHeight - t.offsetHeight - e);
        }
        return {
          y: Math.round(e),
          x: Math.round(o),
      ...
      function i(t) {
        ...
        if (window.getComputedStyle) {
          ...
          t.currentStyle &&
            ((e = t.currentStyle.display), (o = t.currentStyle.visibility));
      ...
      function x(t, e) {
        if (t.pageX || t.pageY) var i = { x: t.pageX, y: t.pageY };
        var n = document.documentElement,
          ...
          r = o(e);
        return (
          (i.x = i.x - r.x + e.scrollLeft), (i.y = i.y - r.y + e.scrollTop), i
        );
      }
      function b(t, e) {
        if (!t || !e) return !1;
      ...
      !(function() {
        ...
        (t._tooltip = {}),
          ...
          (t._is_cursor_under_tooltip = function(t, e) {
            return (
              (t.x >= e.pos.x && t.x <= e.pos.x + e.width) ||
              (t.y >= e.pos.y && t.y <= e.pos.y + e.height)
            );
          }),
          (t._show_tooltip = function(i, n) {
            if (!t.config.touch || t.config.touch_tooltip) {
              ...
              s === t.$root && (f = { x: 0, y: 0 }),
                t._waiAria.tooltipVisibleAttr(r),
                (n.y += f.y);
              var d = { x: n.x, y: n.y };
              (n.x += 1 * t.config.tooltip_offset_x || 0),
                (n.y += 1 * t.config.tooltip_offset_y || 0),
                (n.y = Math.min(Math.max(f.y, n.y), f.y + c - a)),
                (n.x = Math.min(Math.max(f.x, n.x), f.x + u - l)),
                t._is_cursor_under_tooltip(d, {
                  pos: n,
                  width: l,
                  height: a
                }) &&
                  (d.x + l > u + f.x &&
                    (n.x =
                      d.x - (l - 20) - (1 * t.config.tooltip_offset_x || 0)),
                  d.y + a > c + f.y &&
                    (n.y =
                      d.y - (a - 40) - (1 * t.config.tooltip_offset_y || 0))),
                (r.style.left = n.x + "px"),
                (r.style.top = n.y + "px");
            }
          }),
          ...
          (t._tooltip_pos = function(t) {
            if (t.pageX || t.pageY) var o = { x: t.pageX, y: t.pageY };
            var n =
                document.documentElement ||
                document.body.parentNode ||
                document.body,
          ...
          t.attachEvent("onMouseMove", function(e, o) {
            if (this.config.tooltip_timeout) {
              document.createEventObject &&
                ...
                (o = document.createEventObject(o));
              var i = this.config.tooltip_timeout;
              this._tooltip_id &&
                !e &&
                (isNaN(this.config.tooltip_hide_timeout) ||
                  (i = this.config.tooltip_hide_timeout)),
                clearTimeout(t._tooltip_ev_timer),
                (t._tooltip_ev_timer = setTimeout(function() {
                  t._init_tooltip(e, o);
                }, i));
          ...
          (t._init_tooltip = function(t, e) {
            if (
              !this._is_tooltip(e) &&
              (t != this._tooltip_id || this._is_task_line(e))
            ) {
